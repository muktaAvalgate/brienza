		...
		<fieldset>
    		<legend>Basic Info</legend>
		  	...
		  	<?php if($user->role_id == '4'){ ?>
				...
				<?php if(isset($user->meta['principal_name'])){ ?>
					<div class="form-group">
						<label for="inputName" class="col-sm-3 control-label">Principal</label>
						<div class="col-sm-7">
							<p class="form-control-static" id="inputsName"><?php echo $user->meta['principal_name'];?></p>
							<input type="hidden" name="meta[principal_name]" class="form-control" id="inputName" placeholder="Enter principal name" value="<?php if(isset($user->meta['principal_name'])) {echo $user->meta['principal_name'];}?>" required>
							<div class="help-block with-errors"></div>
						</div>
					</div>
				<?php }else{ ?>
					<div class="form-group">
						<label for="inputName" class="col-sm-3 control-label">Principal</label>
						<div class="col-sm-7">
							<p class="form-control-static" id="inputsName"><?php echo 'N/A'; ?></p>
						</div>
					</div>
				<?php } ?>
