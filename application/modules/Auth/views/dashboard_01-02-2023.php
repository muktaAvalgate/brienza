					...
					<div class="panel-heading">
                        <div class="row">
							...
							<div class="col-xs-4 text-right" style="margin-left:1rem;">
                                <img src="<?php echo base_url('assets/images/hazard.png');?>" alt="hazard" width="55" height="33" class="bgimg"style="margin-top:1.3rem;">
                                <div style="margin-top: -2rem; font-weight: bold; text-align: center; margin-right: -1rem;"><?php echo $log_details;?></div><br>
                                <?php if($log_details!=false){ ?>
                                	<div class="huge-heading" style="margin-right: 0.7rem; margin-top: -22px;">Logs</div> 
								<?php }else{ ?>
                                    <div class="huge-heading" style="margin-right: 0.7rem; margin-top: -2px;">Logs</div> 
								<?php } ?>
                            </div>
