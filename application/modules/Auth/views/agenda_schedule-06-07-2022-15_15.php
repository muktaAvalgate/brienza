						...
						<div class="col-md-12">
							...
							<div class="form-group">
								<select name="status" class="form-control" id="status_list">
									...
									<option value="Create log" <?php if ($filter['status'] == 'Create+log') { echo "selected";}?>>Create log</option>
									...
									<option value="Rejected - reschedule" <?php if ($filter['status'] == 'Rejected+-+reschedule') { echo "selected";}?>>Rejected - reschedule</option>

									<option value="Rejected - don''t want" <?php if ($filter['status'] == 'Rejected+-+don%27%27t+want') { echo "selected";}?>>Rejected - don''t want</option>
								</select>
							</div>
							</div>
							...
							<tr>
								<td colspan="5">
									<table class="table sub-order" width="100%">
										<tr>
											<th onclick="dateByAscending();">Session
												<?php if(isset($filter['sessionSort']) && $filter['sessionSort'] == 'DESC'){ ?>
											...
											<th>Presenter</th>
											<th onclick="statusByAscending();">Status
												<?php if(isset($filter['statusSort']) && $filter['statusSort'] == 'DESC'){ ?>
													<i class="arrow down" id="down"></i>
												<?php }else{ ?>
													<i class="arrow up"></i>
