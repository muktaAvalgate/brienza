			...
			$this->form_validation->set_rules('total_hours', 'Total hours', 'trim|required');
     		...
     		if ($this->form_validation->run())
     		{
				...
				if ($schedule_id = $this->App_model->insert('order_schedules', $data)) {
                    ...
                    $msg = "<p>Hi,</p><br><p>This is to notify that a new schedule has been added.</p><br>";
                    
                    $subject = "BAASP UPDATE - " . $presenter_name->first_name . " " . $presenter_name->last_name . " - Order: " . $order_number->order_no;
                    // echo $msg;die;
                    // $emails = array('KConte@brienzas.com','DMaddaloni@brienzas.com');
