	...
	**/
	...
	public function logs() {
        ...
        if($logStatus == 'log_writing_room' || $logStatus == '' || $logStatus == 'page'){
            ...
            $tem_list = $this->App_model->custom_tmp($filterLogWritingRm, false); //get custom template
	...
	public function custom_template_for_admin(){
        ...
        $template_topic_id = $this->App_model->get_topic_from_custom_template();
	...
	public function favorite_template($id=null) {
		$favorite_template = $this->App_model->favorite_template();
