                    ...
                    if ($status[$order_schedule_id] == "Log sent - awaiting principal signature") {
                     ...
                     for( $i=0; $i < $arr_loop_count; $i++){
                        ...
                        $logDatanew .= '
                            ...
                            <td colspan="2"><strong style = "margin-left: 24rem !important; ">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Total Hours:</strong> '. $schedule->total_hours.'</td>
                           </tr>
