            ...
            foreach ($status as $order_schedule_id => $stat) {
                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    if ($status[$order_schedule_id] == "Log sent - awaiting principal signature") {
                        ...
                        $data['content'] = '
                        <table width="100%" cellpadding="5" cellspacing="0"  style = "font-size: 13.5px; font-family:\'Ubuntu\', sans-serif;">
                        <tr>
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 13.5px; font-family:\'Ubuntu\', sans-serif; width: 99.5%; margin-left: 7px;">
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 13.5px; font-family:\'Ubuntu\', sans-serif; width: 99.5%; margin-left: 7px;">
                        ...
                        if ($arr_length <= 800) {
                            ...
                            $font_size = '9.5px';
                        }else if($arr_length <= 1400) {
                            $font_size = '9px';
                        }else if($arr_length <= 1600) {
                            $font_size = '8px';
                        }else if($arr_length <= 1800) {
                            $font_size = '7px';
                        }else if($arr_length <= 2300) {
                            $font_size = '6px';
                        }else if($arr_length <= 3300) {
                            $font_size = '5px';
                        }else if($arr_length <= 4800) {
                            $font_size = '4.5px';
                        }else if($arr_length <= 6000) {
                            $font_size = '4px';
                        }else{
                            $font_size = '1px';
                        }
