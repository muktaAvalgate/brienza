				...
				// {	
					...
					else
					{
						...
						if($errMsg != ''){
                            ...
                            // modified for filter 
                            if($is_filter != 0){
                                $check_is_exist = $this->App_model->get_assigned_hurs_specific($presenter_id[0],$order_id);
                                if($check_is_exist == FALSE){
                                    ...
                                    $delete_prev_presntrOdr = $this->App_model->delete_prev_presntrOdr($order_id, $presenter_id[0]);
                                    if(!empty($update_data)){
                                        $this->db->insert_batch('order_assigned_presenters', $update_data);
                                    }
                                }
