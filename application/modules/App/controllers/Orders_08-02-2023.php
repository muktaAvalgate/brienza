            ...
            foreach ($status as $order_schedule_id => $stat) {
                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    if ($status[$order_schedule_id] == "Log sent - awaiting principal signature") {
                        ...
                        <tr>
                             <td align="center" colspan="2" style="height:40px; font-size: 18px !important;"><strong><br>'. $schedule->worktype_name.' Sign- In Log</strong></td>
                        </tr>
                        <tr>
                            <td align="center" colspan="2" style="height:40px; font-size: 18px !important;"><strong>Presenter\'s Name:</strong> '. $schedule->first_name." ".$schedule->last_name.'</td>
                        </tr>
                        <tr>
                            <td align="center" colspan="2" style="height:40px; font-size: 18px !important;"><strong>Date:</strong>'. date_display($schedule->start_date, "l, F j, Y").'</td>
                        </tr>
                        <tr>
                            <td align="center" colspan="2" style="height:40px;font-size: 18px !important;"><strong>Start TIme:</strong> '. time_display($schedule->start_date, true).' <strong>End Time:</strong> '. time_display($schedule->end_date, true).' <strong>Total Hours:</strong> '. $schedule->total_hours.'</td>
                        </tr>
                        <tr>
                            <td align="left" colspan="2" style="height:50px; border-top:solid 1px;padding-left: 5px;font-size: 18px !important;"><strong>School:</strong> '. $order->school_name.' <strong>Title:</strong> '. $order->title_name.' <strong>PO#:</strong> '. $order->order_no.'</td>
                        </tr>
                        <tr>
                            <td align="left" colspan="2" style="height:50px; border-top:solid 1px;padding-left: 5px;font-size: 18px !important;"><strong>Topic:</strong> '. $schedule->topic_name.'</td>
                        </tr>';
                     ...
                     for( $i=0; $i < $arr_loop_count; $i++){
                        ...
                        $logDatanew .= '
                            <tr>
                                <td align="left" colspan="2" style="height:50px; border-top:solid 1px;padding-left: 5px; font-size: 18px !important;"><strong>Principal:</strong> '. $principal_nameForLog.'</td>
                            </tr>
                            ...
                            <tr>
                            <td align="left" style="height:50px; padding-left: 5px; font-size: 18px !important;"><strong>Principal’s Signature:</strong></td>
                            <td colspan="2"><strong style = "margin-left: 24rem !important; font-size: 18px !important;">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Total Hours:</strong> '. $schedule->total_hours.'</td>
                           </tr>
                    ...
                    if ($status[$order_schedule_id] == "Awaiting Review") {
                        ...
                        $index_rest_pages = 814;
                            ...
                            <tr>
                                <td><strong>Principal’s Signature:</strong><img src="'.base_url().$data['content'].'"width="100" height="50" style="margin-top:-10px; margin-bottom:-7px;"></td>
                                <td align="right" style="padding-top:22px; width:120px;"><strong style = "margin-left: 12rem;">Total Hours: </strong>'.$schedule->total_hours.'</td>
                            </tr>
