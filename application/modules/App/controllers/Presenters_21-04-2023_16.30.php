					...
					foreach($check_is_unique_invoice_id as $key => $inv_id){
						...
						if($session_to < $current_date && $order_schedules_without_public == 1){
							...
							if($scheduleHours){
								...
								$displayArray['order_schedules'] = $this->App_model->get_order_schedule_by_inv_id($val['order_id'], $presenter_id, $inv_id->invoice_id, $val['bill_period_start_date'],$sessionEndDate,$schedules_id,'1');
