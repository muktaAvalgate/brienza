                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 14.5px;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        <tr style="height:40px;">
                            ...
                            <td colspan="2" style="text-align: center;  font-size: 14.5px; border-right: 1px solid;"> <strong>Date of Service:</strong> <br><strong> ' . date("j/n/Y", strtotime($schedule->start_date)) . ' </strong></td>
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 14.5px !important;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        <tr style="height:40px;">
                            ...
                            <td colspan="2" style="text-align: center;  border-right: 1px solid;"> <strong>Date of Service:</strong> <br><strong> ' . date("j/n/Y", strtotime($schedule->start_date)) . ' </strong>
                            </td>
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 14.5px;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        ...
                        <tr>
                            ...
                            <td colspan="3" align="left" style="height:30px;  font-family: timesnewroman;"><strong>Principal’s Signature:</strong> <img src="'.base_url().$data['content'].'"width="100" height="33" style="margin-top:-10px; margin-bottom:-7px;"> </td>
                        </tr>
                    </table>';
                                            ...
                                            <table class="table table-responsive table-hover sub-order" width="100%" cellpadding="0.4" cellspacing="0.2" style="border:0.2px solid #8149ab;">
                                                <thead>
                                                    <tr style="border:1px solid #8149ab;background-color:#9900cc;color:#fff;">
                                                        <th style="color:#fff;text-align: center;font-family:Calibri;width:214px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; border:0.2px solid #8149ab;">Dates of Service</th>
                                                        <th style="color:#fff;text-align: center;width:115px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;font-family:Calibri;border:0.2px solid #8149ab;">Type</th>
                                                        <th style="color:#fff;text-align: center;width:55px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;font-family:Calibri;border:0.2px solid #8149ab;">Total<br> Hours</th>
                                                        <th style="color:#fff;text-align: center;width:71px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;font-family:Calibri;border:0.2px solid #8149ab;">Rate Per<br> Hour</th>
                                                        <th style="color:#fff;text-align: center;width:79px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;font-family:Calibri;border:0.2px solid #8149ab;">Amount<br> Due</th>
                                                    </tr>
                                                </thead>
                                                <tbody>';
                                                if(count($schedules)>0){
                                                    ...
                                                    $invoice_single.='<tr style="background-color: #e0c1ff;">
                                                            <td style="border:0.2px solid #8149ab; background-color: #e0c1ff; font-family:Calibri;width:214px;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">&nbsp;&nbsp;'.date_display($row->start_date, "m/d/Y").' @ '.time_display($row->start_date, true).' to '.time_display($row->end_date, true).'</td>
                                                            <td style="border:0.2px solid #8149ab;background-color: #fff;text-align: center;font-family: Calibri;width:115px;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">&nbsp;&nbsp;'.$row->worktype_name.'&nbsp;&nbsp;</td>
                                                            <td style="border:0.2px solid #8149ab;background-color: #fff;text-align: center;width:54px;font-family:Calibri;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">'.round($row->total_hours).'</td>
                                                            <td style="border:0.2px solid #8149ab;background-color: #fff;text-align: center;width:70px;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><span style="background-color: #fff;padding: 10px 20px;font-family:Calibri;">$'.$row->hourly_rate.'</span></td>
                                                            <td style="border:0.2px solid #8149ab;background-color: #fff;text-align: center; width:77px;font-family:Calibri;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><span style="background-color: #fff;padding: 10px 20px;font-family:Calibri;">$'.$row->hourly_rate*$row->total_hours.'</span></td>
