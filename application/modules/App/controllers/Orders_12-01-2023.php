            ...
            foreach ($status as $order_schedule_id => $stat) {
                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    if ($status[$order_schedule_id] == "Log sent - awaiting principal signature") {
                        ...
                        $data['content_for_print'] = '<table width="110%" cellpadding="5" cellspacing="0"  style="border:1px solid black; font-family:\'Ubuntu\', sans-serif; margin-left: -8rem;">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><strong style = "margin-left: 22rem;">Total Hours:</strong> '. $schedule->total_hours.'</td>
                            </tr>
