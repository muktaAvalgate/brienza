                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 14.5px;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        ...
                        if ($arr_length <= 970) {
                          ...
                          $logDatanew .= '
                            <tr>
                                <td align="left" colspan="2" style="border-top: 1px solid; height: 250px; vertical-align: top; font-size: '.$font_size.';">'.$content_txt.'</td>
                            </tr>';
                ...
                // </table>';
                    ...
                    if($noofschedules <= 43){
                        ...
                        <div style="padding-top:-40px; margin-bottom:10px;padding-left:4.2px;">
                            ...
                            if($nopage == 1){
                                $invoice_single.='<div style="height: 14px;width: 238px;margin-left:409px;border:2px double #8149ab; padding: 5px 0px; 0px 0px; margin-top:6px;">                        
                        ...
                        if($nopage == 1){
                            $invoice.='<div style="height: 14px;width: 238px;margin-left:409px;border:2px double #8149ab; padding: 5px 0px; 0px 0px; margin-top:6px;">                        
                                        <span style="font-family:Calibri; font-size: 14px;">&nbsp;&nbsp;&nbsp;Total: '.$totalHrs.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total: $'.$sum.'</span>
                                    </div>';
                        }
