	...
	**/
	...
	public function export_teacher_report_from_provider(){
        ...
        foreach ($results as $val) {
            $lineData = array($val['session_id'], $val['school_name'], $val['created_by'], $val['teacher'], $val['grade_id'], $val['topic_id'],$val['total_hours'], $val['start_date']);
	...
	public function custom_template_delete($id) {
         ...
         $this->session->set_flashdata('message_type', 'success');
         $this->session->set_flashdata('message', '<strong>Well done!</strong> Template successfully Delete. ');
         redirect('/app/presenters/logs');
    }
	...
	public function favorite_template_delete($id) {
        ...
        $this->session->set_flashdata('message_type', 'success');
        $this->session->set_flashdata('message', '<strong>Well done!</strong>Favorite Template successfully Delete. ');
        redirect('/app/presenters/favorite_template');
    }
