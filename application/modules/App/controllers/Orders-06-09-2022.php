                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    if ($status[$order_schedule_id] == "Awaiting Review") {
                        ...
                        <tr>
                            ...
                            <tr>
                                <td style="height:50px;"><strong>Principal’s Signature:</strong><img src="'.base_url().$data['content'].'"width="100" height="50"></td>
                                <td align="right" style="padding-top:42px; font-size:13px;"><strong>Total Hours:</strong>'.$schedule->total_hours.'</td>
                            </tr>
