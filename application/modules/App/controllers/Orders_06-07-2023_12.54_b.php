            ...
            foreach ($status as $order_schedule_id => $stat) {
                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 14.5px; font-family:Calibri; width: 99.5%; margin-left: 7px;  margin-top: -1rem;">
                        ...
                        $logDatanew = '
                        <table width="100%" cellpadding="5" cellspacing="0"  style = "font-size: 15.5px !important;  font-family: Calibri;">
                        <tr>
                            <td style="float: left; margin-top: 1.1rem; font-size: 15.5px !important;">' . mb_strtoupper($schedule->worktype_name) . ' & Sign-In Log</td>
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 15.5px !important;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        <tr style="height:40px;">
                            <td colspan="4" style="text-align: center;">
                                <table style="width: 100%;" style="font-size: 15.5px !important;">
                                    <tr style="height:40px;">
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 14.5px;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        ...
                        <tr>
                            <td align="left" style="height:30px;  width: 52%; border-right: 1px solid; font-family: timesnewroman;"><strong>Principal’s Name: </strong> <strong>'. $logs_principal_name.'</strong></td>
                            <td align="left" style="height:30px; font-family: timesnewroman;"><strong>Principal’s Signature:</strong> <img src="'.base_url().$data['content'].'"width="100" height="33" style="margin-top:-10px; margin-bottom:-7px;"> </td>
                        </tr>
                    </table>';
                ...
                // </table>';
                    ...
                    if($noofschedules <= 43){
                        ...
                        <div style="padding-top:-40px; margin-bottom:10px;padding-left:4.2px;">
                            ...
                            if($nopage == 1){
                                $invoice_single.='<div style="height: 14px;min-width: 225px;max-width: 225px;margin-left:421px;border:2px double #8149ab; padding: 5px 0px; 0px 0px; margin-top:6px;">                        
                                        <div class="row">
                                            <table width="100%" style="font-family: Calibri;">
                                                    <tr>
                                                        <td style="font-size:14px;width:65px;">&nbsp;Total: '.$totalHrs.'</td>
                                                        <td style="width:66px;">&nbsp;</td>
                                                        <td style="font-size:14px;width:88px;">Total: $'.$sum.'</td>
                                                    </tr>
                                            </table>
                                        </div>
                                    </div>';
                        ...
                        if($nopage == 1){
                            $invoice.='<div style="height: 14px;width: 225px;margin-left:421px;border:2px double #8149ab; padding: 5px 0px; 0px 0px; margin-top:6px;">                        
                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 12.5px;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        ...
                        if ($arr_length <= 970) {
                          ...
                          $data['content'] .= '
                            <tr>
                                <td align="left" colspan="2" style="border-top: 1px solid; height: 250px; vertical-align: top; font-size: '.$font_size.';">'.$content.'</td>
                            </tr>';
        
                         $data['content'] .= '
                        <tr>
                            <td align="left" style="height:30px; border-top: 1px solid; width: 52%; border-right: 1px solid; font-family: timesnewroman;"><strong>Teacher’s Name:</strong> <strong>'.$schedule->teacher.'<strong></td>
                            <td align="left" style="height:30px; border-top: 1px solid; font-family: timesnewroman;"><strong>Teacher’s Signature:</strong></td>
                        </tr>
                        <tr>
                             <td align="left" style="height:30px;  width: 52%; border-right: 1px solid;font-family: timesnewroman;"><strong>Principal’s Name: </strong> <strong>'. $principal_nameForLog.'</strong></td>
                             <td align="left" style="height:30px; font-family: timesnewroman;"><strong>Principal’s Signature:</strong></td>
