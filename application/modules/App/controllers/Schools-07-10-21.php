    	...
    	if ($this->input->server('REQUEST_METHOD') === 'POST')
    	{
    		...
    		if ($this->form_validation->run())
    		{
                ...
                if($success){
                    ...
                    $this->session->set_flashdata('message_type', 'danger');
                    $this->session->set_flashdata('message', '<strong>Oh snap!</strong> Please fill grade and teacher for respective checked off title.');
    		...
    		$this->form_validation->set_rules('titles[]', 'Title', 'trim|required');
     		...
     		if ($this->form_validation->run())
     		{
                ...
                if($success){
                    ...
                    $this->session->set_flashdata('message_type', 'danger');
                    $this->session->set_flashdata('message', '<strong>Oh snap!</strong> Please fill grade and teacher for respective title.');
                    redirect('/app/schools/titles');
                }
                //------------end of validation for grade and teacher field
     		} //validation run
