            ...
            foreach ($status as $order_schedule_id => $stat) {
                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 13.5px; font-family:Calibri; width: 99.5%; margin-left: 7px; margin-top: -1rem;">
                        ...
                        <tr>
                            <td style="margin-top: 0.8rem; float: left;">Vendor: Brienza’s Academic Advantage</td>
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 13.5px; font-family:Calibri; width: 99.5%; margin-left: 7px;  margin-top: -1rem;">
                        <tr style="height:40px;">
                            <td colspan="2" style="">
                                <table style="width: 100%;" style="border: 1px solid black; border-collapse: collapse; font-size: 13.5px;">
                                    <tr>
                                        <td style="text-align: center; border-right: 1px solid; font-size: 13.5px;"> <strong>Date of Service:</strong> <br> <strong>' . date("j/n/Y", strtotime($schedule->start_date)) . '</strong></td>
                                        <td style="text-align: center; border-right: 1px solid; font-size: 13.5px;"><strong>Teacher(s) Name and Grade</strong> <br> <strong>'. $schedule->teacher .', '. $schedule->grade_name .'</strong> </td>
                                        <td style="text-align: center; font-size: 13.5px;"><strong>Session Time:</strong> <br> ' . time_display($schedule->start_date, true) . ' <span> to </span> ' . time_display($schedule->end_date, true) . ' </td>
                                    </tr>
                                </table>
                            </td>
                        </tr>';
                        ...
                        if ($arr_length <= 970) {
                         ...
                         $data['content_for_print'] .= '
                            <tr>
                                <td align="left" colspan="2" style="border-top:solid 1px; height: 250px; font-size: '.$font_size.';">'.$content.'</td>
                            </tr>';
                        ...
                        $logDatanew = '
                        <table width="100%" cellpadding="5" cellspacing="0"  style = "font-size: 15.5px;  font-family: Calibri;">
                        <tr>
                            <td style="float: left; margin-top: 1.1rem;">' . $schedule->worktype_name . ' & Sign- In Log</td>
                            <td style="float: right; padding-left:20rem;"><img src="' . base_url("assets/images/logo.png") . '" style="width: 25%; float: right;"></td>
                        </tr>
                        <tr>
                            <td style="margin-top: 0.4rem; float: left;"><strong>Vendor: Brienza’s Academic Advantage</strong></td>
                        ...
                        <tr>
                            <td align="left" colspan="2" style="float: left; padding-top:-5px;"><strong>School:</strong><strong> ' . $order->school_name . '</strong></td>
                        </tr>
                        <tr>
                            <td align="left" colspan="2" style="float: left; padding-top:-5px;"><strong>Purchase Orderr:</strong> <strong>' . $order->order_no . '</strong> </td>
                        </tr>
                    </table>
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 15.5px;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        <tr style="height:40px;">
                            <td colspan="4" style="text-align: center;">
                                <table style="width: 100%;" style="font-size: 15.5px;">
                                    <tr>
                                        <td style="text-align: center; border-right: 1px solid; font-size: 15.5px;"> <strong>Date of Service:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong> <br><strong> ' . date("j/n/Y", strtotime($schedule->start_date)) . ' </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align: center; border-right: 1px solid; font-size: 15.5px;"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Teacher(s) Name and Grade&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>'. $schedule->teacher .', '. $schedule->grade_name .'</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align: center; font-size: 15.5px;"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Session Time:</strong> <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . time_display($schedule->start_date, true) . ' <span> to </span> ' . time_display($schedule->end_date, true) . ' </td>
                                    </tr>
                                </table>
                            </td>
                        </tr>';
                    ...
                    if ($status[$order_schedule_id] == "Awaiting Review") {
                        ...
                        <tr>
                            <td style="margin-top: 0.8rem; float: left;"><strong>Vendor: Brienza’s Academic Advantage</strong></td>
                            <td align="right" style="position: relative; top: -6px;"><strong>Total Hours of Service:</strong> <span style="color: #51c03de3; font-size: 30px;"><strong><u>' . intval($schedule->total_hours) . '</u></strong> </span> </td>
                        </tr>
                        <tr>
                            <td colspan="2"  style=" float: left; top: -8px; position: relative;"><strong>PRESENTER:</strong>  <strong>' . $schedule->first_name . ' ' . $schedule->last_name . ' </strong> </td>
                        </tr>
	...
	public function save_billing_from_billing(){
        ...
        // echo $sum; die();
                ...
                // </table>';
                    ...
                    // if()
                    $presenter_address = (strlen($pre_ad) > 76) ? substr($pre_ad,0,76).'...' : $pre_ad;
                    ...
                    if($noofschedules <= 43){
                        ...
                        <div style="padding-top:-40px; margin-bottom:10px;">
                            <table width="100%">
                                <tr class="basic_desc">
                                    <td style="text-align: left;"><b>Independent Contractor Invoice</b></td>
                                    <td colspan="4" style="text-align: right;padding-right:20px;">BAA INVOICE #:'.$data['presenter_invoice'].'</td>
                                    <tr>
                                        <td colspan="6"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="5" style="text-align: left;"><b>Address:</b><span style="color:blue;">'. $presenter_address.'</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="6" style="text-align: left;"><b>Phone Number:</b><span style="color:blue;">'. $order->presenter_phone.'</span></td>
                                    </tr>
                            ...
                            <div>
                                <table width="97%" style="padding-top:12px; font-family:Calibri;">
                                    <tr>
                                        <td colspan="6">
                                            <table class="table table-responsive table-hover sub-order" width="100%" cellpadding="1" cellspacing="1" style="">
                                                <thead>
                                                    <tr style="border:1px solid #763199;background-color:#763199;color:#fff;">
                                                        <th style="color:#fff;text-align: center;font-size: 11px;">Dates of Service</th>
                                                        <th style="color:#fff;text-align: center;width:110px;font-size: 11px;">Type</th>
                                                        <th style="color:#fff;text-align: center;width:55px;font-size: 11px;">Total Hours</th>
                                                        <th style="color:#fff;text-align: center;width:82px;font-size: 11px;">Rate Per Hour</th>
                                                        <th style="color:#fff;text-align: center;width:72px;font-size: 11px;">Amount Due</th>
                                                    </tr>
                                                </thead>
                                                <tbody>';
                                                if(count($schedules)>0){
                                                    ...
                                                    $invoice_single.='<tr style="background-color: #e9e9e9">
                                                            <td style="border:1px solid #763199;font-size: 11px;">'.date_display($row->start_date, "m/d/Y").' @ '.time_display($row->start_date, true).' to '.time_display($row->end_date, true).'</td>
                                                            <td style="border:1px solid #763199;background-color: #fff;text-align: center;width:110px;font-size: 11px;">'.$row->worktype_name.'</td>
                                                            <td style="border:1px solid #763199;background-color: #fff;text-align: center;width:55px;font-size: 11px;">'.round($row->total_hours).'</td>
                                                            <td style="border:1px solid #763199;background-color: #fff;text-align: center;width:82px;font-size: 11px;"><span style="background-color: #fff;padding: 10px 20px;">$'.$row->hourly_rate.'</span></td>
                                                            <td style="border:1px solid #763199;background-color: #fff;text-align: center; width:72px;font-size: 11px;"><span style="background-color: #fff;padding: 10px 20px;">$'.$row->hourly_rate*$row->total_hours.'</span></td>
                            ...
                            if($nopage == 1){
                                $invoice_single.='<div style="height: 14px;width: 205px;margin-left:447px;border:2px double #763199; padding: 5px 0px; 0px 0px">                        
                                        <span style="font-size: 11px;">&emsp;Total: '.$totalHrs.'&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  Total: $'.$sum.'</span>
                                    </div>';
                            }
                                
                            $invoice_single.='<div style="margin-top: -10px;" id="footer">
                                <div style="text-align: left;margin-top: -15px;"><tr>
                                    <td colspan="6"><b>Independent Contractor’s Signature</b><img src="'.FCPATH.$content.'" width="150" height="40" style="margin-bottom:-5px;position:fixed;"></td>
                                </tr></div>';
                            
            
                        
                                
                                $invoice_single.='<div style="margin-left:225px;padding-top:10px;">
                                    <strong>Thank you for your business!&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; </strong>';
                                    if($nopage != 1){
                                    $invoice_single.='<strong class="pull-right">Page 1/'.$nopage.'</strong>';
                                    }
                        ...
                        $invoice ='
                            ...
                            $invoice ='<table width="100%">
                                <tr class="basic_desc">
                                    ...
                                    <tr>
                                        <td colspan="6" style="text-align: left;padding-top:-5px;"><b>Name:</b><span style="color:blue;">'. $order->teacher_name.'</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="5" style="text-align: left;"><b>Address:</b><span style="color:blue;">'. $presenter_address.'</span></td>
                                    </tr>
                        ...
                        <div>
                            <table width="97%" style="padding-top:12px;">
                                <tr>
                                    <td colspan="6">
                                        <table class="table table-responsive table-hover sub-order" width="100%" cellpadding="1" cellspacing="1" style="">
                                            <thead>
                        ...
                        if($nopage == 1){
                            $invoice.='<div style="height: 14px;width: 205px;margin-left:447px;border:2px double #763199; padding: 5px 0px; 0px 0px">                        
                                    <span style="font-size: 11px;">&emsp;Total: '.$totalHrs.'&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  Total: $'.$sum.'</span>
                                </div>';
                        }
                        ...
                        $invoice.='<div style="margin-top: -10px;" id="footer">
                            ...
                            $invoice.='<div style="margin-left:225px;padding-top:10px;">
                                <strong>Thank you for your business!&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; </strong>';
                                if($nopage != 1){
                                $invoice.='<strong class="pull-right">Page 1/'.$nopage.'</strong>';
                                }
                        ...
                        for($i=1;$i<$nopage;$i++){
                            ...
                            <div>
                                <table width="97%" style="padding-top:2px;">
                                    <tr>
                                        <td colspan="6">
                                            <table class="table table-responsive table-hover sub-order" width="100%" cellpadding="1" cellspacing="1">
                                                <thead>
                                                    <tr style="border:1px solid #763199;background-color:#763199;color:#fff;">
                                                        <th style="color:#fff;text-align: center;font-size: 11px;">Dates of Service</th>
                                                        <th style="color:#fff;text-align: center;width:110px;font-size: 11px;">Type</th>
                            ...
                            $invoice.='<div style="" id="footer">
                            <div><tr>
                                <td colspan="6" style="text-align: left;"><b>Independent Contractor’s Signature</b><img src="'.FCPATH.$content.'" width="150" height="40" style="margin-bottom:-5px;position:fixed;"></td>
                            </tr></div>';
                            $invoice.='<div style="margin-left:225px;padding-top:10px;">
                                <strong>Thank you for your business!&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; </strong>';
                                if($nopage != 1){
                                $invoice.='<strong class="pull-right">Page '.($i+1).'/'.$nopage.'</strong>';
                                }
                            $invoice.='</div></div><br>';
                        }
                        }
            ...
            foreach ($status as $order_schedule_id => $stat) {
                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 13.5px; font-family:\'Calibri\', sans-serif; width: 99.5%; margin-left: 7px;">
                        ...
                        <table width="100%" cellpadding="5" cellspacing="0"  style = "font-size: 13.5px; font-family:\'Calibri\', sans-serif;">
                        <tr>
                            <th style="float: left;">' . $schedule->worktype_name . ' Sign- In Log</th>
                            <td><img src="' . base_url("assets/images/logo.png") . '" style="width: 36%; float: right;"></td>
                        </tr>
                        <tr>
                            <th style="margin-top: 1rem; float: left;">Vendor: Brienza’s Academic Advantage</th>
                            <th align="right" style=""><strong>Total Hours of Service:</strong> <span style="color: #51c03de3; font-size: 33px;"><u>' . number_format($schedule->total_hours, 1) . '</u> </span> </th>
                        </tr>
                        <tr>
                            <td colspan="2" style="" style=" float: left;"><strong>PRESENTER:</strong>  ' . $schedule->first_name . ' ' . $schedule->last_name . '  </td>
                        </tr>
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 13.5px; font-family:\'Calibri\', sans-serif; width: 99.5%; margin-left: 7px;">
                        <tr style="height:40px;">
                            <td colspan="2" style="">
                                <table style="width: 100%;" style="border: 1px solid black; border-collapse: collapse; font-size: 13.5px;">
                                    <tr>
                                        <td style="text-align: center; border-right: 1px solid; font-size: 13.5px;"> <strong>Date of Service:</strong> <br> ' . date("j/n/Y", strtotime($schedule->start_date)) . '</td>
                                        <td style="text-align: center; border-right: 1px solid; font-size: 13.5px;"><strong>Teacher(s) Name and Grade</strong> <br> '. $schedule->teacher .', '. $schedule->grade_name .' </td>
                                        <td style="text-align: center; font-size: 13.5px;"><strong>Session Time:</strong> <br> ' . time_display($schedule->start_date, true) . ' <span> to </span> ' . time_display($schedule->end_date, true) . ' </td>
                                    </tr>
                                </table>
                            </td>
