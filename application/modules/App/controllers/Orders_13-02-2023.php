            ...
            foreach ($status as $order_schedule_id => $stat) {
                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    if ($status[$order_schedule_id] == "Log sent - awaiting principal signature") {
                        ...
                        <tr>
                             <td><img src="'. base_url("assets/images/logo.png").'" style="padding-left: 20px; padding-top: 10px; width: 90%!important;"></td>
                            <td align="right" style="color:#813D97; !important; padding-right: 20px; padding-top: 10px; width: 50%; font-size: 16px !important;">8696 18th Ave, Brooklyn, NY 11214<br>+718-232-0114 800-581-0887<br>brienzas.com</td>
                        </tr>
                        <tr>
                             <td align="center" colspan="2" style="height:40px; font-size: 20px !important;"><strong><br>'. $schedule->worktype_name.' Sign- In Log</strong></td>
                        </tr>
                        <tr>
                            <td align="center" colspan="2" style="height:40px; font-size: 20px !important;"><strong>Presenter\'s Name:</strong> '. $schedule->first_name." ".$schedule->last_name.'</td>
                        </tr>
                        <tr>
                            <td align="center" colspan="2" style="height:40px; font-size: 20px !important;"><strong>Date:</strong>'. date_display($schedule->start_date, "l, F j, Y").'</td>
                        </tr>
                        <tr>
                            <td align="center" colspan="2" style="height:40px;font-size: 20px !important;"><strong>Start TIme:</strong> '. time_display($schedule->start_date, true).' <strong>End Time:</strong> '. time_display($schedule->end_date, true).' <strong>Total Hours:</strong> '. $schedule->total_hours.'</td>
                        </tr>
                        <tr>
                            <td align="left" colspan="2" style="height:50px; border-top:solid 1px;padding-left: 5px;font-size: 20px !important;"><strong>School:</strong> '. $order->school_name.' <strong>Title:</strong> '. $order->title_name.' <strong>PO#:</strong> '. $order->order_no.'</td>
                        </tr>
                        <tr>
                            <td align="left" colspan="2" style="height:50px; border-top:solid 1px;padding-left: 5px;font-size: 20px !important;"><strong>Topic:</strong> '. $schedule->topic_name.'</td>
                        </tr>';

                        
                            // echo $arr[$index]. " ";
                            $index_first_page=590;

                            $first_page_str_length=3200;
                            $second_page_str_index=3201;

                            $first_page_str = substr($content, 0, $first_page_str_length); 
                            if (strpos($first_page_str, "<br>") != false) {
                                // echo "Word Found!";
                                $break_count = substr_count($first_page_str,"<br>");
                                $index_first_page = $index_first_page - 10*$break_count;
                            }
                        ...
                        $logDatanew .= '<tr>
                            <td  align="left" colspan="2" style="border-top:solid 1px; padding-left: 2px; font-size: 20px !important;">';
                        ...
                        ';    
                        // ...........................................
                        $index_rest_pages = 880;

                        $rest_page_str_length=5700;

                        $rest_page_str = substr($content, $second_page_str_index, $rest_page_str_length); 
                        
                        if (strpos($rest_page_str, "<br>") != false) {
                            // echo "Word Found!";
                            $break_count = substr_count($rest_page_str,"<br>");
                            $index_rest_pages = $index_rest_pages - 15*$break_count;
                        }
                     ...
                     for( $i=0; $i < $arr_loop_count; $i++){
                        // if(!empty($arr[$last_index])){
                            ...
                            $index_str_j=$second_page_str_index+($rest_page_str_length*$i);
                            $rest_page_str_j = substr($content, $index_str_j, $rest_page_str_length);
                            ...
                            if (strpos($rest_page_str_j, "<br>") != false) {
                                // echo "Word Found!";
                                $break_count = substr_count($rest_page_str_j,"<br>");
                                $index_j = $index_j - 15*$break_count;
                            }
                            
                            $logDatanew .= '<tr>
                            <td  align="left" colspan="2" style="padding-left: 2px; font-size: 20px !important;">';
                        ...
                        $logDatanew .= '
                            <tr>
                                <td align="left" colspan="2" style="height:50px; border-top:solid 1px;padding-left: 5px; font-size: 20px !important;"><strong>Principal:</strong> '. $principal_nameForLog.'</td>
                            </tr>
                            ...
                            <tr>
                            <td align="left" style="height:50px; padding-left: 5px; font-size: 20px !important;"><strong>Principal’s Signature:</strong></td>
                            <td colspan="2"><strong style = "margin-left: 24rem !important; font-size: 20px !important;">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Total Hours:</strong> '. $schedule->total_hours.'</td>
                           </tr>
                    ...
                    if ($status[$order_schedule_id] == "Awaiting Review") {
                        ...
                        <tr>
                            <td><img src="'. base_url("assets/images/logo.png").'"></td>
                            <td align="right" style="color:#813D97; font-size: 16px !important;">8696 18th Ave, Brooklyn, NY 11214<br>+718-232-0114 800-581-0887<br>brienzas.com</td>
                        </tr>
                        <tr>
                            <th colspan="2" style="height:40px;font-size: 20px !important;">'. $schedule->worktype_name.' Sign- In Log</th>
                        </tr>
                        <tr>
                            <td align="center" colspan="2" style="height:40px;font-size: 20px !important;"><strong>Presenter\'s Name:</strong> '. $schedule->first_name." ".$schedule->last_name.'</td>
                        </tr>
                        ...
                        <tr>
                            <td align="left" colspan="2" style="height:50px; border-top:solid 1px;font-size: 20px !important;"><strong>School:</strong> '. $order->school_name.' <strong>Title:</strong> '. $order->title_name.' <strong>PO#:</strong> '. $order->order_no.'</td>
                        </tr>
                        <tr>
                            <td align="left" colspan="2" style="height:50px; border-top:solid 1px;font-size: 20px !important;"><strong>Topic:</strong> '. $schedule->topic_name.'</td>
                        </tr>';

                        // ...........................................
                        $index_first_page=580;

                            $first_page_str_length=3200;
                            $second_page_str_index=3201;
                            $first_page_str = substr($content_txt, 0, $first_page_str_length); 
                            if (strpos($first_page_str, "<br>") != false) {
                                // echo "Word Found!";
                                $break_count = substr_count($first_page_str,"<br>");
                                $index_first_page = $index_first_page - 10*$break_count;
                        ...
                        $index_rest_pages = 814;
                            ...
                            $rest_page_str = substr($content_txt, $second_page_str_index, $rest_page_str_length); 
                            ...
                            for( $i=0; $i < $arr_loop_count; $i++){
                                    ...
                                    $index_str_j=$second_page_str_index+($rest_page_str_length*$i);
                                    $rest_page_str_j = substr($content_txt, $index_str_j, $rest_page_str_length);
                            ...
                            <tr>
                                <td align="left" colspan="2" style="height:50px; border-top:solid 1px; font-size: 20px !important;"><strong>Principal:</strong> '. $logs_principal_name.'</td>
                            </tr>
                            ...
                            <tr>
                                <td style="font-size: 20px !important;"><strong>Principal’s Signature:</strong><img src="'.base_url().$data['content'].'"width="100" height="50" style="margin-top:-10px; margin-bottom:-7px;"></td>
                                <td align="right" style="padding-top:22px; width:120px; font-size: 20px !important;"><strong style = "margin-left: 12rem;">Total Hours: </strong>'.$schedule->total_hours.'</td>
                            </tr>
                    ...
                    if ($status[$order_schedule_id] == "Log sent - awaiting principal signature") {
                     ...
                     for( $i=0; $i < $arr_loop_count; $i++){
                        ...
                        $logDatanew .= '
                            ...
                            <tr>
                            <td align="left" style="height:50px; padding-left: 5px; font-size: 20px !important;"><strong>Principal’s Signature:</strong></td>
                            <td colspan="2"><strong style = "margin-left: 24rem !important; font-size: 18px !important;">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Total Hours:</strong> '. $schedule->total_hours.'</td>
                           </tr>
