                        ...
                        $invoice ='
                            ...
                            $invoice ='<table width="100%">
                                <tr class="basic_desc">
                                    ...
                                    <td colspan="4" style="text-align: right;padding-left:98px;">BAA INVOICE #:'.$data['presenter_invoice'].'</td>
                                    <tr>
                                        <td colspan="6"></td>
                                    </tr>
                                    <tr>
                        ...
                        for($i=1;$i<$nopage;$i++){
                            ...
                            $invoice .='
                                <style>
                                    ...
                                    <tr class="basic_desc">
                                        <td style="text-align: left;"><b>Independent Contractor Invoice</b></td>
                                        <td colspan="4" style="text-align: right;padding-left:98px;">BAA INVOICE #:32</td>
                                        <tr>
                                            <td colspan="6"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="6" style="text-align: left;padding-top:-5px;"><b>Name:</b><span style="color:blue;">'. $nopage.'</span></td>
                                        </tr>
                                        <tr>
                                            <td colspan="6" style="text-align: left;"><b>Address:</b><span style="color:blue;">noofschedules-'. $noofschedules.'</span></td>
                                        </tr>
                                        <tr>
                                            <td colspan="6" style="text-align: left;"><b>Phone Number:</b><span style="color:blue;">start counter'. $start_counter.'</span></td>
                                        </tr>
                                        <tr>
                                            <td colspan="6" style="text-align: left;"><b>Date of Submission:</b><span style="color:blue;">'. date("m-d-Y").'</span></td>
                                        </tr>
