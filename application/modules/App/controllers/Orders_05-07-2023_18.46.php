                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 12.5px;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        ...
                        if ($arr_length <= 970) {
                         ...
                         $data['content'] .= '
                        <tr  style="font-family: Times New Roman;">
                            <td align="left" style="height:30px; width: 52%; border-right: 1px solid;"><strong>Teacher’s Name:</strong> <strong>'.$schedule->teacher.'<strong></td>
                            <td align="left" style="height:30px;"><strong>Teacher’s Signature:</strong></td>
                        </tr>
                        <tr  style="font-family: Times New Roman;">
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 14.5px;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        ...
                        if ($arr_length <= 900) {
                         ...
                         $logDatanew .= '
                        <tr  style="font-family: timesnewroman;">
                            <td align="left" style="height:30px; width: 52%; border-right: 1px solid;"><strong>Teacher’s Name:</strong> <strong>'.$schedule->teacher.'<strong></td>
                            <td align="left" style="height:30px;"><strong>Teacher’s Signature:</strong></td>
                        </tr>
                        <tr  style="font-family: timesnewroman;">
                ...
                // </table>';
                    ...
                    if($noofschedules <= 43){
                        ...
                        <div style="padding-top:-40px; margin-bottom:10px;padding-left:4.2px;">
                            ...
                            if($nopage == 1){
                                $invoice_single.='<div style="height: 14px;width: 222px;margin-left:425px;border:2px double #8149ab; padding: 5px 0px; 0px 0px; margin-top:6px;">                        
                                        <div class="row">
                                            <table width="100%" style="font-family: Calibri;">
                                                    <tr>
                                                        <td style="font-size:14px;width:62px;">&nbsp;Total: '.$totalHrs.'</td>
                        ...
                        if($nopage == 1){
                            $invoice.='<div style="height: 14px;width: 222px;margin-left:425px;border:2px double #8149ab; padding: 5px 0px; 0px 0px; margin-top:6px;">                        
                                        <div class="row">
                                            <table width="100%" style="font-family: Calibri;">
                                                    <tr>
                                                        <td style="font-size:14px;width:62px;">&nbsp;Total: '.$totalHrs.'</td>
