                ...
                // </table>';
                    ...
                    if($noofschedules <= 43){
                        ...
                        <div style="padding-top:-40px; margin-bottom:10px;padding-left:4.2px;">
                            ...
                            if($nopage == 1){
                                $invoice_single.='<div style="height: 14px;width: 239px;margin-left:411px;border:2px double #8149ab; padding: 5px 0px; 0px 0px; margin-top:6px;">                        
                        ...
                        if($nopage == 1){
                            $invoice.='<div style="height: 14px;width: 239px;margin-left:411px;border:2px double #8149ab; padding: 5px 0px; 0px 0px; margin-top:6px;">                        
                                        <span style="font-family:Calibri; font-size: 14px;">&nbsp;&nbsp;Total: '.$totalHrs.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total: $'.$sum.'</span>
                                    </div>';
                        }
