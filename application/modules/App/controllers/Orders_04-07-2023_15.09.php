            ...
            foreach ($status as $order_schedule_id => $stat) {
                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    $data['content'] = '
                        ...
                        <tr>
                            <td style="margin-top: 0.4rem; float: left; width: 50%"><strong>Vendor: Brienza’s Academic Advantagg</strong></td>
                        ...
                        <tr style="height:40px;">
                            <td colspan="4" style="text-align: center;">
                                <table style="width: 100%;" style="font-size: 15.5px;">
                                    <tr>
                                        <td style="text-align: center;  font-size: 15.5px; border-right: 1px solid;"> <strong>Date of Service:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong> <br><strong> ' . date("j/n/Y", strtotime($schedule->start_date)) . ' </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align: center;  font-size: 15.5px; border-right: 1px solid;"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Teacher(s) Name and Grade&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>'. $schedule->teacher .', '. $schedule->grade_name .'</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 13.5px; font-family:Calibri; width: 99.5%; margin-left: 7px;  margin-top: -1rem;">
                        <tr style="height:40px;">
                            <td colspan="2" style="">
                                <table style="width: 100%;" style="border: 1px solid black; border-collapse: collapse; font-size: 13.5px;">
                                    <tr>
                                        <td style="text-align: center;  font-size: 13.5px;"> <strong>Date of Service:</strong> <br> <strong>' . date("j/n/Y", strtotime($schedule->start_date)) . '</strong></td>
                                        <td style="text-align: center;  font-size: 13.5px;"><strong>Teacher(s) Name and Grade</strong> <br> <strong>'. $schedule->teacher .', '. $schedule->grade_name .'</strong> </td>
                        ...
                        <tr>
                            <td style="margin-top: 0.4rem; float: left; width: 50%"><strong>Vendor: Brienza’s Academic Advantage</strong></td>
                            <td align="right" style="margin-top: -10px"><strong>Total Hours of Service:</strong> <span style="color: #51c03de3; font-size: 30px;"><strong><u>' . intval($schedule->total_hours) . '</u> <strong></span> </td>
                        </tr>
                        <tr>
                            <td colspan="2" style=" float: left; padding-top:-5px;"><strong>PRESENTER:</strong> <strong> ' . $schedule->first_name . ' ' . $schedule->last_name . ' </strong> </td>
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 14.5px;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        <tr style="height:40px;">
                            <td colspan="4" style="text-align: center;">
                                <table style="width: 100%;" style="font-size: 14.5px;">
                                    <tr>
                                        <td style="text-align: center;  font-size: 14.5px; border-right: 1px solid;"> <strong>Date of Service:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong> <br><strong> ' . date("j/n/Y", strtotime($schedule->start_date)) . ' </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
                        ...
                        if ($arr_length <= 970) {
                          ...
                          $logDatanew .= '
                            <tr>
                                <td align="left" colspan="2" style="border-top: 1px solid; height: 250px; font-size: '.$font_size.';">'.$content.'</td>
                            </tr>';
        
                         $logDatanew .= '
                        <tr  style="font-family: Times New Roman;">
                            <td align="left" style="height:30px; border-top:1px solid; width: 52%; border-right: 1px solid;"><strong>Teacher’s Name:</strong> <strong>'.$schedule->teacher.'<strong></td>
                            <td align="left" style="height:30px; border-top: 1px solid;"><strong>Teacher’s Signature:</strong></td>
                        </tr>
                        <tr  style="font-family: Times New Roman;">
                             <td align="left" style="height:30px;  width: 52%; border-right: 1px solid;"><strong>Principal’s Name: </strong> <strong>'. $principal_nameForLog.'</strong></td>
                             <td align="left" style="height:30px; "><strong>Principal’s Signature:</strong></td>
                ...
                // </table>';
                    ...
                    if($noofschedules <= 43){
                        ...
                        <div style="padding-top:-40px; margin-bottom:10px;padding-left:4.2px;">
                                            ...
                                            <table class="table table-responsive table-hover sub-order" width="100%" cellpadding="0.4" cellspacing="0.2" style="border:0.2px solid #8149ab;">
                                                <thead>
                                                    <tr style="border:1px solid #8149ab;background-color:#9900cc;color:#fff;">
                                                        ...
                                                        <th style="color:#fff;text-align: center;width:55px;font-family:Calibri;border:0.2px solid #8149ab;">Total Hours</th>
                                                        <th style="color:#fff;text-align: center;width:71px;font-family:Calibri;border:0.2px solid #8149ab;">Rate Per Hour</th>
                            ...
                            if($nopage == 1){
                                $invoice_single.='<div style="height: 14px;width: 245px;margin-left:402px;border:2px double #8149ab; padding: 5px 0px; 0px 0px; margin-top:6px;">                        
                                        <span style="font-family:Calibri; font-size: 14px;">&nbsp;&nbsp;Total: '.$totalHrs.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total: $'.$sum.'</span>
                                    </div>';
                            }
                            ...
                            $invoice_single.='<div style="margin-top: -10px;" id="footer">
                                ...
                                $invoice_single.='<div style="margin-left:272px;padding-top:10px;">
                                    <strong style="font-family:Calibri;font-size: 16px;">Thank you for your business!&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; </strong>';
                                    if($nopage != 1){
                        ...
                        if($nopage == 1){
                            $invoice.='<div style="height: 14px;width: 245px;margin-left:402px;border:2px double #8149ab; padding: 5px 0px; 0px 0px; margin-top:6px;">                        
                                        <span style="font-family:Calibri; font-size: 14px;">&nbsp;&nbsp;Total: '.$totalHrs.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total: $'.$sum.'</span>
                                    </div>';
                        }
                            ...
                            $invoice .='
                                <style>
                                    ...
                                    if($i == 1){
                                        ...
                                        $invoice .='<div style="margin-top:40px; margin-bottom:10px;">';
                                    }else{
                                        $invoice .='<div style="margin-top:40px; margin-bottom:10px;">';
                                    }
                                    $invoice .='<table width="100%">
