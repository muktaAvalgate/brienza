	...
	public function save_billing_from_billing(){
        ...
        // echo $sum; die();
                ...
                $invoice ='<table width="100%">
                            ...
                            <table class="table table-responsive table-hover sub-order" width="100%">
                                <thead>
                                    ...
                                    if(count($schedules) <= 10){
                                        $invoice.='<th style="color:#fff;">Dates of Service</th>
                                        <th style="color:#fff;width: 107px;">Total Hours</th>
                                        <th style="color:#fff;width: 130px;">Rate Per Hour</th>
                                        <th style="color:#fff;width: 115px;">Amount Due</th>';
                                    }else if(count($schedules)>10 && count($schedules) <= 20){
                                        $invoice.='<th style="color:#fff;width: 750px;">Dates of Service</th>
                                        <th style="color:#fff;width: 107px;">Total Hours</th>
                                        <th style="color:#fff;width: 130px;">Rate Per Hour</th>
                                        <th style="color:#fff;width: 115px;">Amount Due</th>';
                                    }else if(count($schedules)>20 && count($schedules) <= 25){
                                        $invoice.='<th style="color:#fff;width: 850px;">Dates of Service</th>
                                        <th style="color:#fff;width: 107px;">Total Hours</th>
                                        <th style="color:#fff;width: 130px;">Rate Per Hour</th>
                                        <th style="color:#fff;width: 115px;">Amount Due</th>';
                                    }else if(count($schedules)>25 && count($schedules) <= 30){
                                        $invoice.='<th style="color:#fff;width: 950px;">Dates of Service</th>
                                        <th style="color:#fff;width: 107px;">Total Hours</th>
                                        <th style="color:#fff;width: 130px;">Rate Per Hour</th>
                                        <th style="color:#fff;width: 115px;">Amount Due</th>';
                                    }else if(count($schedules)>30 && count($schedules) <= 35){
                                        $invoice.='<th style="color:#fff;width: 1000px;">Dates of Service</th>
                                        <th style="color:#fff;width: 107px;">Total Hours</th>
                                        <th style="color:#fff;width: 130px;">Rate Per Hour</th>
                                        <th style="color:#fff;width: 115px;">Amount Due</th>';
                                    }else if(count($schedules)>35 && count($schedules) <= 40){
                                        $invoice.='<th style="color:#fff;width: 1150px;">Dates of Service</th>
                                        <th style="color:#fff;width: 107px;">Total Hours</th>
                                        <th style="color:#fff;width: 130px;">Rate Per Hour</th>
                                        <th style="color:#fff;width: 115px;">Amount Due</th>';
                                    }else if(count($schedules)>40 && count($schedules) <= 45){
                                        $invoice.='<th style="color:#fff;width: 1350px;">Dates of Service</th>
                                        <th style="color:#fff;width: 107px;">Total Hours</th>
                                        <th style="color:#fff;width: 130px;">Rate Per Hour</th>
                                        <th style="color:#fff;width: 115px;">Amount Due</th>';
                                    }else if(count($schedules)>45){
                                        $invoice.='<th style="color:#fff;width: 1450px;">Dates of Service</th>
                                        <th style="color:#fff;width: 107px;">Total Hours</th>
                                        <th style="color:#fff;width: 130px;">Rate Per Hour</th>
                                        <th style="color:#fff;width: 115px;">Amount Due</th>';
                                    }
                    ...
                    <tr>
                        <td colspan="6" style="text-align: left"><b>Independent Contractor’s Signature</b><img src="'.FCPATH.$content.'" width="80" height="40"></td>
                    </tr>
                    <tr>
                        <td colspan="6"></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="6" style="text-align: center"><b><h3>Thank you for your business!</h3></b></td>
                    </tr>
                </table>';
