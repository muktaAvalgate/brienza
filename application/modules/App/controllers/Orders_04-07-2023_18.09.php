        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            foreach ($status as $order_schedule_id => $stat) {
                ...
                if($status[$order_schedule_id] == 'Confirm hours'){
                    ...
                    $data['content'] = '
                        <table width="100%" cellpadding="5" cellspacing="0"  style = "font-size: 12.5px;  font-family: Calibri;">
                        <tr>
                        ...
                        <tr>
                            <td style="margin-top: 0.4rem; float: left; width: 40%"><strong>Vendor: Brienza’s Academic Advantage</strong></td>
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 12.5px;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        <tr style="height:40px;">
                            <td colspan="4" style="text-align: center;">
                    ...
                    <table cellpadding="5" cellspacing="0"  style="border:1px solid black; font-size: 14.5px;  font-family: Calibri; width: 99.5%; margin-left: 7px;">
                        ...
                        if ($arr_length <= 970) {
                          ...
                          $logDatanew .= '
                            <tr>
                                <td align="left" colspan="2" style="border-top: 1px solid; height: 250px; font-size: '.$font_size.';">'.$content_txt.'</td>
                            </tr>';
                        ...
                        <tr  style="font-family: Times New Roman;">
                            <td align="left" style="height:30px;  width: 52%; border-right: 1px solid;"><strong>Principal’s Name: </strong> <strong>'. $logs_principal_name.'</strong></td>
