...
<div class="subnav">
   <div class="container-fluid">
       <h1><span class="fa fa-user-plus"></span> Manage Logs</h1>
       ...
       <table class="table table-striped table-responsive">
           ...
           <tbody>
               ...
               <tr>
                   ...
                   <td> <?php echo (strlen($list->tmp_name)>25) ? substr($list->tmp_name,0,25).'....': $list->tmp_name; ?> </td>
                   <td><?php echo (strlen($list->message)>50) ? substr($list->message,0,50).'....': $list->message ; ?> </td>
