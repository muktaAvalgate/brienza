      ...
      <div class="row vertical-align">
        <div class="col-xs-6 col-md-8" style = "font-size: 13.5px; font-family: 'Calibri', sans-serif;">
            ...
            ?>
                ...
                <tr>
                    <td style=" float: left; margin-top: 1.1rem;"><?php echo $schedule->worktype_name;?> & Sign- In Log</td>
                ...
                <tr>
                    <td align="left" colspan="2" style=" float: left; top: -14px; position: relative;"><strong>School:</strong> <strong><?php echo $order->school_name;?></strong> </td>
                </tr>
                <tr>
                ...
                <tr style="height:40px;">
                    <td  colspan="2" style="">
                        <table style="width: 100%;"  style = "  border: 1px solid black; border-collapse: collapse">
                            <tr>
                                <td style = "text-align: center; border-right: 1px solid;"> <strong>Date of Service:</strong> <br>  <strong><?php echo date("j/n/Y", strtotime($schedule->start_date)); ?></strong></td>
