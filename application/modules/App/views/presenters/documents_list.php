...
<div class="container-fluid main">
	<ol class="breadcrumb">
		...
		<ol>
			<div class="row">
				<button type="button" class="btn btn-warning btn-xs" style="float: right;margin-bottom: 17px; margin-right: 12px" onclick="window.location.href = '<?php echo base_url('app/presenters/export_teacher_report_from_provider/') ?>'">Export Teacher Report</button>
