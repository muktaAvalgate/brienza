   ...
   <div class="col-sm-8">
       ...
       <fieldset>
           ...
           <div class="form-group">
               ...
               <div class="col-sm-10">
                   <input type="text" name="tmp_name" class="form-control" id="tmp_name" placeholder="Template Name" value="" required>
           ...
           <div class="form-group">
               ...
               <div class="col-sm-10">
                   <textarea class="form-control" name="message" id="message_nn" placeholder="Compose your message .." rows="15" required ></textarea>
                   <div class="help-block with-errors"></div>
               </div>
           </div>
