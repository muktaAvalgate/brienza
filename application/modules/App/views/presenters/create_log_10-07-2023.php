...
<div class="container" style = "margin-left: 1rem;">
      <div class="row vertical-align">
        <div class="col-xs-6 col-md-8" style = "font-size: 13.5px; font-family: 'Calibri', sans-serif;">
            ...
            <div><img src="<?php echo base_url('assets/images/hr_line.png');?>" style="position: absolute;margin-left: 13rem;width: 1px;height: 51px;margin-top: -16px;"></div>

            <div><img src="<?php echo base_url('assets/images/hr_line.png');?>" style="position: absolute;margin-left: 34.9rem;width: 1px;height: 51px;margin-top: -16px;"></div>
            ...
            <table  cellpadding="5" cellspacing="0" border="0" class="table_align_bottom" style = "font-family: 'Calibri', sans-serif;">
                <tr style="height:40px;">
                    <td  colspan="2" style="">
                        <table style="width: 100%;"  style = "  border: 1px solid black; border-collapse: collapse">
                            <tr>
                                <td style = "text-align: center;"> <strong>Date of Service:</strong> <br>  <strong><?php echo date("j/n/Y", strtotime($schedule->start_date)); ?></strong></td>
                                <td style = "text-align: center;"><strong>Teacher(s) Name and Grade</strong> <br> 
                ...
                <tr style="font-family: Times New Roman;">
                    <td align="left" style="height:30px; border-top:solid 1px; width: 52%; border-right: 1px solid;"><strong>Teacher’s Name:</strong> <strong><?php echo $schedule->teacher; ?></strong></td>
                ...
                <tr style="font-family: Times New Roman;">
                    <!-- <?php //if(isset($principal_name)){ ?> -->
                        <td align="left" style="height:30px;  width: 52%; border-right: 1px solid;"><strong>Principal’s Name: </strong> 
                            <input type="text" name="principal_nameForLog" class="form-control" id="inputName"  placeholder="Enter name" value="<?php if(isset($principal_name)) {echo $principal_name->meta_value;}?>" >
                        </td>
                    <!-- <?php //}else{ ?> -->
                        <!-- <td align="left" style="height:30px;  width: 52%; border-right: 1px solid;"><strong>Principal’s Name: </strong> 
