            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-9" style="">
                    <?php if (isset($favorite_template->message)){ ?>
                     <a  class="btn btn-primary" style="margin-left: -70px! important;" onclick="edit()" id="updateMsg"><span class="glyphicon glyphicon-ok-sign"></span> Update</a>
                     <a  class="btn btn-primary" style="margin-left: -70px! important;" id="updateDisabled" disabled="disabled" ><span class="glyphicon glyphicon-ok-sign"></span> Update</a>
                    <?php } else {?>
                    <button class="btn btn-primary" style="margin-left: -70px! important;" id="save_button">Save</button>
