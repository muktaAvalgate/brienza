...
<div class="subnav">
	<div class="container-fluid">
    	<h1 style="margin-left:3.8rem;">Logs</h1>

    

			<div class="row  log-view-tab-wrapper tab_width">
                <div class="col-md-12">
                    <ul>
                        <?php if($logStatus == 'log_writing_room' || $logStatus == '' || $logStatus == 'page'){ ?>
                            <li style="padding: 0 15px;"><a href="<?php echo base_url('app/presenters/logs/'.'log_writing_room');?>" id="log-writing-room" class="active" style="font-family: inherit;">Log Writing Room</a></li>
                        <?php }else{ ?>
                            <li style="padding: 0 15px;"><a href="<?php echo base_url('app/presenters/logs/'.'log_writing_room');?>" id="log-writing-room" style="font-family: inherit;">Log Writing Room</a></li>
                        <?php } ?>
                        
                        <?php if($logStatus == 'submitted_logs'){ ?>
                            <li><a  href="<?php echo base_url('app/presenters/logs/'.'submitted_logs');?>" id="submitted-logs" class="active" style="font-family: inherit;">Submitted Logs</a></li>
                        <?php }else{ ?>
                            <li><a  href="<?php echo base_url('app/presenters/logs/'.'submitted_logs');?>" id="submitted-logs" style="font-family: inherit;">Submitted Logs</a></li>
                        <?php } ?>  
                    </ul>
                </div>
            </div>
	...
	function viewTemplateModal(template_id){
        ...
        jQuery.ajax({
            ...
            success: function (response) {
				...
				$('.view_message').html(response.message);
