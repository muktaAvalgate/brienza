						...
						<tr class="gradeA odd" role="row">
							...
							<td class="col-md-2">
								<select name="grades" class="form-control grades">
									<option>Select</option>
									<?php foreach ($teacher_grades as $item) {?>
										<option value="<?php echo $item->grade_id;?>" data-slug="<?php echo $item->school_id; ?>" data-orderId="<?php echo $order_id; ?>"><?php echo $item->grade_name;?></option>
							...
							<td>
								...
								<input type="text"  value="" class="form-control inputteacher" placeholder="" name="teachers" required>
							</td>
							<td class="col-md-1">
...
$(document).ready(function(){
    ...
    $('.saveBtn').on('click',function(){
        ...
        if(trObj.find(".editInput.grade").val() == ""){
