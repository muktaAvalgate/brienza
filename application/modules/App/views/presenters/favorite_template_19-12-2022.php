        ...
        <div class="col-sm-12">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="message" id="message" placeholder="Enter the template text..." rows="15"  required ><?php if(isset($favorite_template->message)){ echo $favorite_template->message ;} ?></textarea>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-9" style="">
                    <?php if (isset($favorite_template->message)){ ?>
                     <a  class="btn btn-primary" onclick="edit()"><span class="glyphicon glyphicon-ok-sign"></span> Update</a>
                    <?php } else {?>
                    <button class="btn btn-primary">Save</button>
                    <div style="margin-left:7rem; margin-top:-2.5rem;"> or <a href="<?php echo base_url('app/presenters/logs');?>">Cancel</a></div>
                    <?php }?> 
                    
                    <?php if(isset($favorite_template->id)){ ?> 
                    <div style="margin-left:10rem; margin-top:-3.9rem;">
                    ...
                    <div style="margin-left:20rem; margin-top:-2.5rem;"> or <a href="<?php echo base_url('app/presenters/logs');?>">Cancel</a></div>
                     <?php } ?>
                     <div class="help-block with-errors"></div>
                </div>
