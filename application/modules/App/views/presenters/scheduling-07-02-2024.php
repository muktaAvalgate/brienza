					...
					<tbody>
						...
						<tr class="gradeA odd" role="row" data-id="<?php echo $row->id; ?>"data-school-id="<?php echo $row->school_id; ?>" data-order-id="<?php echo $row->order_id;?>" data-status="<?php echo $row->status;?>">
					    	...
					    	<td>
								...
								<input type="hidden" id="apprvTchrVal<?php echo $row->id; ?>" value="<?php echo $row->teacher;?>">
							...
							<td>
								...
								<!-- <button type="button" class="btn btn-sm btn-success saveDateBtn" style="float: none; display: none;">Save</button> -->
...
$(document).ready(function(){
    $('.editBtn').on('click',function(){
		...
		// var data_status = $('#statusForSave').val();
		// alert(data_status);
