...
<div id="msgModal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close show_loader" data-dismiss="modal">&times;</button>
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default show_loader" data-dismiss="modal">Close</button>
	      </div>
	    </div>
