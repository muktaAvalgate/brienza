...
<div class="container-fluid main">
   ...
   <div>
       <button class="btn btn-primary log_template" onclick="window.location='<?php echo base_url('app/presenters/add_log_template');?>'">Add Log Template</buttton>
   </div>
   <div>
   <?php
