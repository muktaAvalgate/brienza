      ...
      <div class="row vertical-align">
        ...
        <div class="col-xs-6 col-md-4" style=" margin-left: 1rem;">
            ...
            <!-- <select class="button_template"  name="topic" class="form-control" id="topic_template" style="width:14%">
                ...
                <div id="first_button">
					<div>
						<input type="button" class="button_template" value="View Brienza Templates" id="View_brienza_templates" onclick="View_brienza_templates();"> </input>
					</div>
				...
				<div id="secondary_button" style="display:none;">
					<div>
						<input type="button" class="button_template" value="View Brienza Templates" id="View_brienza_templates" onclick="View_brienza_templates_second();"> </input>
					</div>
