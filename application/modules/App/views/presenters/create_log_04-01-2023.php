		...
		<!-- <tr>
			...
			<tr>
				<td align="right" colspan="2" style="height:50px; border-top:solid 1px;">
					...
					<input type="button"  class="btn btn-primary principal_sign"  value="Save as custom template" onclick="save_custom_template(<?php if(isset($schedule->topic_id)){ echo $schedule->topic_id;} ?>)">
