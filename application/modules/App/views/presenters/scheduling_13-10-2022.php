...
<script>
	...
	function requestTeacher(){
		...
		if(teachername != '' && grade_name != ''){
			grade_name_edited = grade_name.replace(/\s+/g, '_');
			window.location.href=base_url+'app/notifications/request_new_teacher/'+teachername+'/'+grade_name_edited;
		}else{
			if(teachername == '' && grade_name == ''){
				alert('Please fill the teacher\'s name and grade.');
			}else if(teachername == ''){
				alert('Please fill the teacher\'s name.');
			}else if(grade_name == ''){
