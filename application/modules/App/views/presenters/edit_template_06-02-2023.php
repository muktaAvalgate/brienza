   ...
   <div class="col-sm-15">
       ...
       <fieldset>
           ...
           <div class="form-group">
               ...
               <div class="col-sm-10">
                   <textarea class="form-control" name="message" id="edit_essage" placeholder="Enter the template text..." rows="15" style="margin-left: -70px! important; width: 104rem;" required ><?php echo $log_content->message; ?></textarea>
                   <div class="help-block with-errors"></div>
               </div>
           </div>
