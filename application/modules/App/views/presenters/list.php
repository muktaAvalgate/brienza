			...
			<div class="row" style="float:right">
				<div class="col-sm-4">
					<div class="form-group has-search">
						<span class="fa fa-search form-control-feedback" style="margin-right: 47px;margin-top: 5px;"></span>
						<input type="text" class="form-control" placeholder="Search" value="<?php if(isset($filter['search_box']) && $filter['search_box'] != ''){ echo $filter['search_box'];} ?>" id="search_box">
					</div>
				</div>
			</div>
		</legend>
		<div class="row">
			<div class="col-md-12">
				...
				<div class="form-group" >
					<select name="presenter" id="presenter" class="form-control" style="width: 19rem;">
				...
				<div class="form-group" >
					<select name="company" id="company" class="form-control" style="width: 19rem;">
				...
				<?php //}?>
				<!-- <div class="form-group" >
                    <select name="email" id="email" class="form-control" style="width: 19rem;" >
...
<script type="text/javascript">
	...
	function export_presenters(){
		...
		var search_box = jQuery('#search_box').val();
		// alert(search_box);
		if(search_box == ''){
			document.location.href = base_url+'app/presenters/export_presenters?presenter=' + pre + '&company=' + company;
		}else{
			document.location.href = base_url+'app/presenters/export_presenters?search_box=' + search_box;
		}
	}
	...
	//use it:
	$('#search_box').pressEnter(function(){
		var search1 = $('#search_box').val();
		if(search1 == ''){
			document.location.href = base_url+'app/presenters/index/';
		}else{
			var search = btoa(search1);
			document.location.href = base_url+'app/presenters/index/search_box/'+search;
		}
