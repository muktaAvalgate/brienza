        ...
        <div class="col-sm-12">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="message" id="message" placeholder="Enter your Favorite Template..." rows="15"  required ><?php if(isset($favorite_template->message)){ echo $favorite_template->message ;} ?></textarea>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-9" style="">
                    <?php if (isset($favorite_template->message)){ ?>
                     <a  class="btn btn-primary" onclick="edit()"><span class="glyphicon glyphicon-ok-sign"></span> Edit</a>
                    <?php } else {?>
