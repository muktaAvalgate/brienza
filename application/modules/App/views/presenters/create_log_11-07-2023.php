...
<div class="container" style = "margin-left: 1rem;">
      <div class="row vertical-align">
        <div class="col-xs-6 col-md-8" style = "font-size: 13.5px; font-family: 'Calibri', sans-serif;">
            ...
            ?>
                <table  cellpadding="5" cellspacing="0" border="0" class="table_align_top" style = "font-family: 'Calibri', sans-serif;">
                <tr>
                    <!-- <td style=" float: left; margin-top: 1.1rem;"><?php //echo  mb_strtoupper($schedule->worktype_name);?> & Sign-In Log</td> -->
                ...
                <tr>
                    ...
                    <td align="right" style="position: relative; top: -6px;"><strong>Total Hours of Service:</strong> <span style = "color: #51c03de3; font-size: 33px;"><strong><u><?php echo intval($schedule->total_hours);?></u></strong> </span> </td>
                </tr>
                <tr>
                    <td colspan="2"  style=" float: left; top: -8px; position: relative;"><strong>PRESENTER:</strong> <strong> <?php echo $schedule->first_name." ".$schedule->last_name;?></strong> </td>
                    
                </tr>
                <tr>
                    <td align="left" colspan="2" style=" float: left; top: -14px; position: relative;"><strong>School:</strong> <?php echo $order->school_name;?> </td>
                </tr>
                <tr>
                    <td align="left" colspan="2" style="float: left; top: -21px; position: relative;"><strong>Purchase Order:</strong> <strong><?php echo $order->order_no;?></strong> </td>
                </tr>
            
            </table>
            
            <table  cellpadding="5" cellspacing="0" border="0" class="table_align_bottom" style = "font-family: 'Calibri', sans-serif;">
                <tr style="height:40px;">
                   
                    <td colspan="2" style = "text-align: center;  border-right: 1px solid;"> <strong>Date of Service:</strong> <br>  <strong><?php echo date("j/n/Y", strtotime($schedule->start_date)); ?></strong></td>
                    <td colspan="2" style = "text-align: center;  border-right: 1px solid;"><strong>Teacher(s) Name and Grade</strong> <br> 
                    <strong><?php echo $schedule->teacher; ?>, <?php echo $schedule->grade_name; ?></strong></td>
                    <td colspan="2" style = "text-align: center;"><strong>Session Time:</strong> </br> <?php echo time_display($schedule->start_date, true);?> <span> to </span> <?php echo time_display($schedule->end_date, true);?> </td>
                        
                </tr>
                <tr>
                    <td align="left" colspan="6" style="border-top:solid 1px;">
                ...
                <tr style="font-family: Times New Roman;">
                    <td colspan="3" align="left" style="height:30px; border-top:solid 1px; width: 52%; border-right: 1px solid;"><strong>Teacher’s Name:</strong> <strong><?php echo $schedule->teacher; ?></strong></td>
                ...
                <tr style="font-family: Times New Roman;">
                    <!-- <?php //if(isset($principal_name)){ ?> -->
                        <td colspan="3" align="left" style="height:30px;  width: 52%; border-right: 1px solid;"><strong>Principal’s Name: </strong> 
                            <input type="text" name="principal_nameForLog" class="form-control" id="inputName"  placeholder="Enter name" value="<?php 
                               if(isset($principal_name)) {
                                $meta_value = $principal_name->meta_value;
                                if ($meta_value === 'N/A') {
                                    $meta_value = '';
                                }
                                echo $meta_value;
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="3" style="height:50px; border-top:solid 1px;">
    ...
    <script>
        ...
        $(document).mouseup(function(e){
			...
			if (!View_brienza_templates.is(e.target) && View_brienza_templates.has(e.target).length === 0){
                var container_a = $("#list");

                // if the target of the click isn't the container nor a descendant of the container
                if (!container_a.is(e.target) && container_a.has(e.target).length === 0) 
                {
                    container_a.hide();
                    is_open_list = 0;
                }
			...
			if (!View_brienza_templates_second.is(e.target) && View_brienza_templates_second.has(e.target).length === 0){
                ...
                var container_b = $("#list_2");

                // if the target of the click isn't the container nor a descendant of the container
                if (!container_b.is(e.target) && container_b.has(e.target).length === 0) 
                {
                    container_b.hide();
                    is_open_list_2 = 0;
                }
