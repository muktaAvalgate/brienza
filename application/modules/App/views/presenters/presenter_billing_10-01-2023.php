                                                            ...
                                                            <div id="print_log">
                                                                ...
                                                                <!-- <input type="file" name="attachment[<?php echo $row->id;?>]" class="upload_file" > -->
                                                                    ...
                                                                    <div class="fileUpload btn btn-sm btn-primary" style=" padding: 2px 10px;margin-top: 3px; margin-left: 0rem;">
                                                                        ...
                                                                        <input id="photo<?php echo $orderSchedules->order_schedule_status_id;?>" type="file" class="upload" onchange="upload_document_for_presenter('<?php echo $orderSchedules->order_schedule_status_id;?>','<?php echo $orderSchedules->id;?>');"/>
                                                                    </div>
                                                                <!-- For update attach file -->
