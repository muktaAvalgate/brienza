<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-equalizer"></span> Titles</h1>

        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
				<li class="active"><?php echo render_link('index', '<span class="glyphicon glyphicon-equalizer"></span> Titles');?></li>
...
<div class="container-fluid main">
	...
	<?php
		...
		echo form_open(base_url('app/categories/update_status'), $attributes);
	?>
