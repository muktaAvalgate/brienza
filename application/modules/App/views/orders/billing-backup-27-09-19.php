	...
	<td colspan="5" id="sub-order-<?php echo $order->id;?>">
		<table class="table sub-order" width="100%">
			...
			<tr>
				...
				<td><?php echo date_display($row->start_date, "l, F j, Y");?> @ <?php echo $row->teacher;?> <?php echo time_display($row->start_date, true);?>-<?php echo time_display($row->end_date, true);?><br/>
					<?php echo "Topic - ". $row->topic_name; ?>	
				</td>
				<!-- end code (2019-07-23) -->
				...
				<td width="25%">
					...
					<br> <a href="javascript:;"  class="show_logs"  data-id="<?php echo $row->id ?>">Expand</a>
				</td>
			</tr>
			<?php foreach ($row->order_log as $k1 => $order_log) {?>
				<tr style="display: none;"  class="show_log_<?php echo $row->id ?>">
					...
					<td><?php echo date_display($row->start_date, "l, F j, Y");?> @ <?php echo $row->teacher;?> <?php echo time_display($row->start_date, true);?>-<?php echo time_display($row->end_date, true);?>
