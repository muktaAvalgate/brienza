	        ...
	        <tbody>
				...
				<td class="sorting_1" style="padding-right: 8px;width: 180px;"><?php echo $item->order_no;?>
					<?php if($item->re_upload_change == 1 && $item->late_flag == 1){ ?>
						<div class="mainAdmin">
						<div class="latetagbillAdmin">Late</div><img src=<?php echo base_url('assets/dist/images/hazard.png')?> style="width: 20px; height: 20px; text-align: center;"></div>
					<?php }else{
						if($item->re_upload_change == 1){ ?>
							<div class="changetagbillAdmin" style="top: 18px;"><img src=<?php echo base_url('assets/dist/images/hazard.png')?> style="width: 20px; height: 20px; text-align: center;"></div>
						<?php }
						if($item->late_flag == 1){ ?>
