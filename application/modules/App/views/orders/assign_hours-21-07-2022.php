    ...
    ?>	
    	<div class="row">
			...
			<div class="col-sm-2">
				...
				<button type="button" class="btn btn-primary" onclick=assignHoursSingle(<?php echo $presenter_id; ?>);>Assign</button>
			</div>
		</div>
    <?php
    	} 
			...
			jQuery.ajax({
				...
				success: function (response) {
					if(response == 5){
						...
						alert('Well done! Hours are successfully assigned to presenters.');
