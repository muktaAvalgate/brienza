<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-bookmark"></span> Participant</h1>

        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
				<li class="active"><?php echo render_link('index', '<span class="glyphicon glyphicon-bookmark"></span> Participant');?></li>
				<li><?php echo render_link('add', '<span class="glyphicon glyphicon-plus-sign"></span> Create New Participant');?></li>
    		</ul>
        </div>
    </div>
</div>
...
<div class="container-fluid main">
	...
	<?php
		...
		echo form_open(base_url('app/participanttype/update_status'), $attributes);
	?>
	    ...
	    <table class="table table-striped table-responsive" width="100%">
	        ...
	        <tbody>
	            ...
	            <tr>
	            	...
	            	<td style="display: grid;width: 0px;margin-left: 45px;">
...
<div class="modal fade bs-example-modal-sm" id="viewTeacherModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<?php
		...
		echo form_open(base_url('app/participanttype'), $attributes);
	?>
