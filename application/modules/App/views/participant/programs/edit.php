<div class="subnav">
	<div class="container-fluid">
		<h1><span class="glyphicon glyphicon-bookmark"></span> Edit Program &raquo; <small> <?php echo $grade->name;?></small></h1>
...
<div class="container-fluid main">
	<ol class="breadcrumb">
		...
		<li><a href="<?php echo base_url('app/programs');?>">Programs</a></li>
	...
	<?php
		...
		echo form_open_multipart(base_url('app/programs/edit/'.$grade->id), $attributes);
   	?>
	...
	<div class="col-sm-6">
		...
		<fieldset>
			...
			<p><a class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this?')" href="<?php echo base_url('app/programs/delete/'.$grade->id);?>"><span class="glyphicon glyphicon-trash"></span> Delete this Program</a></p>
    	</fieldset>
