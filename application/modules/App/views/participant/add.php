<div class="subnav">
	<div class="container-fluid">
		<h1><span class="glyphicon glyphicon-bookmark"></span> Add New Participant</h1>

        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
				<li><?php echo render_link('index', '<span class="glyphicon glyphicon-bookmark"></span> Participants');?></li>
				<li class="active"><?php echo render_link('add', '<span class="glyphicon glyphicon-plus-sign"></span> Create New Participant');?></li>
    		</ul>
        </div>
    </div>
</div>
...
<div class="container-fluid main">
	<ol class="breadcrumb">
		...
		<li><a href="<?php echo base_url('app/categories');?>">Participant</a></li>
	...
	<?php
		...
		echo form_open_multipart(base_url('app/participanttype/add/'), $attributes);
   	?>
