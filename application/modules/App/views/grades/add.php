<div class="subnav">
	<div class="container-fluid">
		<h1><span class="glyphicon glyphicon-bookmark"></span> Create New Grade</h1>

        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
				<li><?php echo render_link('index', '<span class="glyphicon glyphicon-bookmark"></span> Grades');?></li>
				<li class="active"><?php echo render_link('add', '<span class="glyphicon glyphicon-plus-sign"></span> Create New Grade');?></li>
    		</ul>
        </div>
    </div>
</div>
...
<div class="container-fluid main">
	...
	<?php
		...
		echo form_open_multipart(base_url('app/grades/add/'), $attributes);
   	?>
