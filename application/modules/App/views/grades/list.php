<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-bookmark"></span> Grades</h1>

        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
				<li class="active"><?php echo render_link('index', '<span class="glyphicon glyphicon-bookmark"></span> Grades');?></li>
...
<div class="container-fluid main">
	...
	<?php
		...
		echo form_open(base_url('app/grades/update_status'), $attributes);
	?>
