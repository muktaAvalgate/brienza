...
<div class="container-fluid main">
    ...
    ?>
    <fieldset>
        <legend><span class="glyphicon glyphicon-filter"></span> Filters
			<div class="row" style="float:right">
				<div class="col-sm-4">
					<div class="form-group has-search">
						<span class="fa fa-search form-control-feedback" style="margin-right: 47px;margin-top: 5px;"></span>
						<input type="text" class="form-control" placeholder="Search" value="<?php if(isset($filter['search_box_schl']) && $filter['search_box_schl'] != ''){ echo $filter['search_box_schl'];} ?>" id="search_box_schl">
					</div>
				</div>
			</div>
		</legend>
