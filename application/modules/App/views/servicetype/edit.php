<div class="subnav">
	<div class="container-fluid">
		<h1><span class="glyphicon glyphicon-bookmark"></span> Edit Service type &raquo; <small> <?php echo $grade->name;?></small></h1>

        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
				<li><?php echo render_link('index', '<span class="glyphicon glyphicon-bookmark"></span>  Service type');?></li>
				<li><?php echo render_link('add', '<span class="glyphicon glyphicon-plus-sign"></span> Create Service type');?></li>
    		</ul>
        </div>
    </div>
</div>
...
<div class="container-fluid main">
	...
	<?php
		...
		echo form_open_multipart(base_url('app/Servicetype/edit/'.$grade->id), $attributes);
   	?>
		...
		<fieldset>
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-6">
					<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-ok-sign"></span> Save Service type</button> or <a href="<?php echo base_url('app/Servicetype');?>">Cancel</a>
				</div>
			</div>
		</fieldset>
	</div>
	...
	<div class="col-sm-6">
		...
		<fieldset>
			...
			<p><a class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this?')" href="<?php echo base_url('app/Servicetype/delete/'.$grade->id);?>"><span class="glyphicon glyphicon-trash"></span> Delete this Service type</a></p>
    	</fieldset>
