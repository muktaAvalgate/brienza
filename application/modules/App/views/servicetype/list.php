<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-bookmark"></span> Service type</h1>

        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
				<li class="active"><?php echo render_link('index', '<span class="glyphicon glyphicon-bookmark"></span> Service type');?></li>
				<li><?php echo render_link('add', '<span class="glyphicon glyphicon-plus-sign"></span> Create New Service type');?></li>
    		</ul>
        </div>
    </div>
</div>
...
<div class="container-fluid main">
	...
	<?php
		...
		echo form_open(base_url('app/Servicetype/update_status'), $attributes);
	?>
