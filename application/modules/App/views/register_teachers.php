				...
				<div class="login-container">
					...
					<div class="row">
						<div class="col-md-5 col-sm-12 blocks block-1">
							...
							<p>Suspendisse dapibus volutpat lacus, sit amet imperdiet ante tempus fermentum. Etiam lacus metus, elementum mattis commodo ac, commodo a nunc.</p>-->
						</div>
						<div class="col-md-7 col-sm-12 blocks block-2">
							...
							<div id="teacher_info">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<p class="form-control-static"><?php echo $teacher->first_name;?></p>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<p class="form-control-static"><?php echo price_display($teacher->meta['rate']);?></p>
									</div>
									<div class="col-sm-4">
										<p class="form-control-static"><?php if(isset($teacher->meta['rate_file'])) {echo anchor(base_url(DIR_TEACHER_FILES.strtolower($teacher->meta['rate_file'])),"Download Rate File", array("target"=>"_blank"));}?></p>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<p class="form-control-static"><?php if(isset($teacher->meta['phone'])) {echo $teacher->meta['phone'];}?></p>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">Member Since</label>
									<div class="col-sm-8">
										<p class="form-control-static"><?php echo date_display($teacher->created_on);?></p>
									</div>
								</div>
								<div class="form-group">
							...
							<div id="teacher_edit" style="display:none">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" id="inputName" name="name" placeholder="Enter name " value="<?php echo $teacher->first_name;?>" required >
										<div class="help-block with-errors"></div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" id="inputPhone" name="meta[phone]" placeholder="Enter phone " value="<?php echo $teacher->meta['phone'];?>" required>
										<div class="help-block with-errors"></div>
									</div>
								</div>
								<div class="form-group">
								...
								<input type="hidden" name="user_id" value="<?php echo $teacher->id;?>">
								<input type="hidden" name="created_by" value="<?php echo $teacher->created_by;?>">
								<input type="hidden" name="email" value="<?php echo $teacher->email;?>">
								<input type="hidden" name="meta[category_id]" value="<?php if(isset($teacher->meta['category_id'])) {echo $teacher->meta['category_id'];}?>">
								<input type="hidden" name="meta[info]" value="<?php echo $teacher->meta['info'];?>">
								<input type="hidden" name="meta[rate]" value="<?php echo $teacher->meta['rate'];?>">
								<input type="hidden" name="meta[rate_file]" value="<?php if(isset($teacher->meta['rate_file'])) {echo $teacher->meta['rate_file'];}?>">
								<?php echo form_close();?>
							</div>
