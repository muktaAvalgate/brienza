	        ...
	        <tbody>
	            ...
	            <tr>
	            	<td><input type="checkbox" name="item_id[<?php echo $teacher->id;?>]" class="checkbox-item" value="Y"></td>
								...
								<td><?php if (isset($teacher->meta['rate_type'])){ echo $teacher->meta['rate_type'];  ?></td>
								...
								echo ($teacher->meta['rate_type'] == 'Percentage') ? $teacher->meta['rate'].'%' : '$'.number_format($teacher->meta['rate'], 2); }else{ ?>  <td> <?php } ?>
