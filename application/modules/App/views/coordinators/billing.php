                ...
                <tbody>
					...
					<?php foreach($orders as $order) {?>					
						<tr class="gradeA <?php echo ($i%2==0)?'even':'odd'?>" role="row">
							...
							<td>
								<!-- <a href="<?php //echo base_url('app/presenters/billing/?order_id='.$order->id);?>"> -->
							...
							<!-- <td class="center"><a href="<?php //echo base_url("app/presenters/scheduling/?school_id=".$order->school_id."&order_id=".$order->id);?>" class="btn btn-success">Schedule hours</a></td> -->
							<td class="center"><a href="<?php echo base_url("app/presenters/billing/?order_id=".$order->id);?>" class="btn btn-success" target="_blank">Billing</a></td>
						</tr>
						<?php $i++;?>
					<?php }?>
