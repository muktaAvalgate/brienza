<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-time"></span> Add Payment Schedule</h1>
        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
				<li><?php echo render_link('index', '<span class="glyphicon glyphicon-time"></span> Payment Schedules');?></li>
				<li class="active"><a href="<?php echo base_url('app/payroll/payment_schedules_add');?>"><span class="glyphicon glyphicon-plus-sign"></span> Add Payment Schedule</a></li>
    		</ul>
        </div>
    </div>
</div>
...
<div class="container-fluid main">
	<ol class="breadcrumb">
		...
		<li class="active">Add Payment Schedule</li>
	</ol>
	...
	<?php
		...
		echo form_open_multipart(base_url('app/payroll/payment_schedules_add'), $attributes);
      ?>
      	...
      	<fieldset>
    		<legend>Schedule Info</legend>
		  	...
		  	<div class="form-group">
		  		<label for="session_from" class="col-sm-3 control-label">Session Period Start Date *</label>
		  		<div class="col-sm-7">
		  			<input type="text" name="session_from" class="form-control" id="session_from_fixed" placeholder="Enter Session Start date" value="<?php echo date('m/d/Y', strtotime($sessionstartDate)); ?>" readonly required />
		  	...
		  	<div class="form-group">
		  		...
		  		<div class="col-sm-7">
		  			<input type="text" name="session_to" class="form-control" id="session_to_fixed" placeholder="Enter Session End date" value="<?php echo date('m/d/Y', strtotime($sessionendDate)); ?>" readonly required />
		  			<div class="help-block with-errors"></div>
		  		</div>		  		
		  	</div>
			...
			<div class="form-group">
		  		...
		  		<div class="col-sm-7">
		  			<input type="text" name="billing_date" class="form-control disable-pre-date-calender" id="billing_date" placeholder="Enter Billing Date" value="<?php echo set_value('billing_date'); ?>" required>
		  			<div class="help-block with-errors"></div>
		  		</div>
		  	</div>
			...
			<div class="form-group">
		  		...
		  		<div class="col-sm-7">
		  			<input type="text" name="payment_date" class="form-control disable-pre-date-calender" id="payment_date" placeholder="Enter Payment Date" value="<?php echo set_value('payment_date'); ?>" required>
		  			<div class="help-block with-errors"></div>
		  		</div>
		  	</div>
			...
			<div class="form-group">
		  		...
		  		<div class="col-sm-7">
		  			<input type="text" name="email_remonder_date" class="form-control disable-pre-date-calender" id="email_remonder_date" placeholder="Enter Email Reminder Date" value="<?php echo set_value('email_remonder_date'); ?>" required>
		  			<div class="help-block with-errors"></div>
		  		</div>
		  	</div>		  	
