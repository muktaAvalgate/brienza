		...
		<div class="col-md-9">
            ...
            <?php if($folder=="logs" && $this->session->userdata('role') == 'administrator'){ ?>
                <div class="notification-list <?php echo $folder;?>" id="notification_list">
                    ...
                    <table class="table table-responsive" width="100%">
                        <tbody>
                            <?php if (count($unread_logs) == 0) { ?>
                            <!-- <tr>
                                <td colspan="100%">Your list is emptyy.</td>
                            </tr> -->
                            <?php } ?>
                            <tr>
                            ...
                            <?php foreach($unread_logs as $logs) {  ?>

                                <?php 
                                    if(!empty($logs->content_for_print)){
                                ?>
                            <tr>
                                <td> <?php echo $logs->start_date ?> </td>
                                <td> <?php echo $logs->total_hours ?> </td>
                                <td> <?php echo $logs->order_no ?> </td>
                ...
                <div style="margin-left:-34%"><?php echo $this->pagination->create_links(); ?></div>
                <?php }else{ ?>
