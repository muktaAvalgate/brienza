                        ...
                        <?php if($unread_logs != false){ foreach($unread_logs as $logs) { //echo'<pre>';print_r($logs);die; ?>
                            ...
                            ?>
                                ...
                                <!-- <td><?php echo date_display($row->start_date, "m/d/Y");?> @ <?php echo time_display($row->start_date, true);?>-<?php echo time_display($row->end_date, true);?> with <?php echo $row->teacher;?> </td> -->
                                    ...
                                    <td> <span style="font-weight:bold; color:#4d4e4f; margin-left: 2rem;"><?php echo $logs->order_no ?></span> </td>
                                    <!-- <td> <?php echo $pdf ?> </td> -->
                                    <td ><a href="<?php echo base_url('app/notifications/log_download/'.$logs->order_id); ?>"><img src="<?php echo base_url('assets/images/pdf_download.png'); ?>" style="border-radius:1% !important; border: 1px solid #ffffff; !important; width:65px !important; height:40px !important;" alt="" title="Click here to download log"></a></td>
                                </tr>
                            <?php }else{ ?>
                                    <tr>
                                        ...
                                        <td> <span style="margin-left: 2rem;"><?php echo $logs->order_no ?></span> </td>
                                        <!-- <td><a href="<?php echo base_url('app/notifications/log_download/'.$logs->order_id); ?>"><img src="<?php echo base_url('assets/dist/images/attachment-icon.png'); ?>" border="0" alt="" title="Click here to download log"></a></td> -->
                                        <td ><a href="<?php echo base_url('app/notifications/log_download/'.$logs->order_id); ?>"><img src="<?php echo base_url('assets/images/pdf_download.png'); ?>" style="border-radius:1% !important; border: 1px solid #ffffff; !important; width:65px !important; height:40px !important;" alt="" title="Click here to download log"></a></td>
                                    </tr>
