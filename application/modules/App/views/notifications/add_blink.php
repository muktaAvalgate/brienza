...
<div class="container-fluid main">
	...
	<?php
		...
		echo form_open(base_url('app/notifications/add_blink/?folder='.$folder), $attributes);
	?>
	...
	<div class="col-sm-8">
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
                 <div>
  					<input  name="teacher_name" class="form-control"  value="<?php if(isset($teacher_name)){echo $teacher_name;}?>" readonly>
				</div>
					<div class="help-block with-errors"></div>
				</div>
				...
				<div class="col-sm-9">
					<div>
						<input name="grade" class="form-control" value="<?php if(isset($grade)){echo $grade;}?>" readonly>
					</div>
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-9">
				<button type="submit" class="btn btn-primary" id="submitRequest"><span class="glyphicon glyphicon-ok-sign"></span> Send</button> or <a href="<?php echo base_url('app/notifications/redirect_to_scheduling');?>">Cancel</a>
			</div>
		</div>
	...
	<div class="col-sm-4">
		<fieldset>
    		...
    		<div><input type="checkbox" name="usersbox" id="chkbx">Select All</div>
...
<script>
	...
	jQuery(document).ready(function(){
		...
		jQuery("#submitRequest").click(function(){
			...
			$('#send-notify-form').submit();
			
		});

		jQuery("#chkbx").click(function(){
			if(jQuery(this).is(":checked")){
				jQuery(".checkbox-item").prop('checked', 'checked');
			}else{
				jQuery(".checkbox-item").prop('checked', '');
			}
	    });
	});
</script>
