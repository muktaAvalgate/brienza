	...
	<div class="col-sm-8">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-9">
				<button type="submit" class="btn btn-primary" id="submitRequest"><span class="glyphicon glyphicon-ok-sign"></span> Send</button> or <a href="<?php echo base_url('app/notifications');?>">Cancel</a>
			</div>
		</div>
