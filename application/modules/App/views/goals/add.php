<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="fa fa-gg-circle"></span> Add New Goal</h1>
        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
				<li><?php echo render_link('index', '<span class="fa fa-gg-circle"></span> Goals');?></li>
				<li class="active"><?php echo render_link('add', '<span class="glyphicon glyphicon-plus-sign"></span> Add New Goal');?></li>
    		</ul>
        </div>
    </div>
</div>
...
<div class="container-fluid main">
	<ol class="breadcrumb">
		...
		<li class="active">Add New Goal</li>
	</ol>
	...
	<?php
		...
		echo form_open_multipart(base_url('app/goals/add'), $attributes);
  ?>
	...
	<div class="col-sm-6">
      ...
      <fieldset>	
			...
			<div class="form-group">
			  		...
			  		<div class="col-sm-7">
			  			<input type="text" name="start_date" class="form-control" id="session_from" placeholder="Enter start date" value="<?php echo set_value('start_date'); ?>" required >
			  			<div class="help-block with-errors"></div>
			  		</div>
			  	</div>
				...
				<div class="form-group">
			  		...
			  		<div class="col-sm-7">
			  			<input type="text" name="end_date" class="form-control" id="session_to" placeholder="Enter end date" value="<?php echo set_value('end_date'); ?>" required>
			  			<div class="help-block with-errors"></div>
			  		</div>
			  	</div>
			  	...
			  	<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="number" name="amount" class="form-control" id="inputName" placeholder="Enter amount" value="<?php echo set_value('amount'); ?>" required>
						<div class="help-block with-errors"></div>
					</div>
			    </div>
