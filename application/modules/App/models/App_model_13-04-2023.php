...
*/
    ...
    **/
    ...
    public function get_order_schedule_with_range_not_submitted($order_id=null, $presenter_id=null,$firstDate, $endDate, $group_by='') {
        $order_id = (int) $order_id;
    ...
    public function get_order_schedule_by_inv_id($order_id=null, $presenter_id=null,$inv_id, $group_by='') {
        $order_id = (int) $order_id;
