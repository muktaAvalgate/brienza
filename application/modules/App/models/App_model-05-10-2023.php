...
*/
    ...
    **/
    ...
    public function getpdf_merge() {
        $this->db->select('
            CONCAT(users.first_name, " ", users.last_name) AS presenter_name,
            orders.order_no,orders.id As order_id,
            order_schedule_status_log.attachment,
            order_schedule_status_log.school_pdf,order_schedule_status_log.id,billing.id AS billing_id,billing.is_merged'
        );
        // $this->db->select('
        //     CONCAT(users.first_name, " ", users.last_name) AS presenter_name,
        //     orders.order_no,
        //     orders.id AS order_id,
        //     DISTINCT order_schedule_status_log.attachment,
        //     order_schedule_status_log.school_pdf,         
        //     order_schedule_status_log.id,
        ...
        $this->db->join('orders', 'orders.id = order_schedules.order_id');
        $this->db->join('order_schedule_status_log', 'order_schedule_status_log.order_schedule_id = order_schedules.id');
        $this->db->join('billing', 'billing.order_id = orders.id');
        
        $this->db->where('order_schedule_status_log.pdf_merge_status', '0');
        // $this->db->where('orders.is_deleted', '0');
        // $this->db->group_by('order_schedule_status_log.attachment');
