...
*/
    ...
    **/
	...
	function get_school_titles($school_id) {
        ...
        $this->db->where('school_titles.is_deleted', 0); // 11-07-2023
    ...
    function check_schedule_datetime($presenter_id = '', $start_date='', $end_date='') {
        ...
        $this->db->join('orders', 'orders.id = order_schedules.order_id'); //26-06-2023
        $this->db->where('orders.is_deleted', 0); //26-06-2023
    ...
    **/
    ...
    // public function get_assignable_presenters($coordinator_id = NUll, $school_id= NULL)
    ...
    **/
    ...
    public function get_schedule_details_by_bw_date($fromDate, $toDate) {
        ...
        $this->db->select('order_schedules.*, orders.order_no');
        ...
        $this->db->where('DATE(order_schedules.start_date) >=', date('Y-m-d',strtotime($fromDate)));

        $this->db->where('DATE(order_schedules.start_date) <=', date('Y-m-d',strtotime($toDate)));
    ...
    public function getorder_billing_period($order_id){
        ...
        if($query->num_rows() > 0 && !is_null($query->row()->start_date)){
            ...
            $lastScheduleDate = $query->row()->start_date;
            ...
            $this->db->where('session_from <= ',$lastScheduleDate);

            $this->db->where('session_to >=',$lastScheduleDate);
    ...
    public function get_previous_orders($presenter_id){
        ...
        $static_date = '2021-10-25 00:00:00';
