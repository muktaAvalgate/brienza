    ...
    public function ordersBillingStatusUpdate_post() {
        ...
        $attachment = (isset($_FILES['attachment'])?$_FILES['attachment']:"");
            ...
            if ($status == "Log sent - awaiting principal signature") {
                ...
                <tr> 
                    <td align="left" colspan="2" style="border-top:solid 1px; padding: 20px;">'.nl2br($content).'</td>
                </tr>
                ...
                <tr>
                    <td><img src="'. base_url("assets/images/logo.png").'" style="padding-left: 20px; padding-top: 10px; width: 90% !importent;"></td>
                    <td align="right" style="color:#813D97; !important; padding-right: 20px; padding-top: 10px; width: 50%;">8696 18th Ave, Brooklyn, NY 11214<br>+718-232-0114 800-581-0887<br>brienzas.com VUTT</td>
                </tr>
                <tr>
                    <td align="center" colspan="2" style="height:40px; font-size: 15px;"><strong><br>'. $schedule->worktype_name.' Sign- In Log</strong></td>
                </tr>
        ...
        if ($status == "Awaiting Review") {
            foreach($order_schedule_id_mul as $order_schedule_id){
                // if ($status == "Awaiting Review") {
                    ...
                    <tr>
                        <td><img src="'. base_url("assets/images/logo.png").'"></td>
                        <td align="right" style="color:#813D97;">8696 18th Ave, Brooklyn, NY 11214<br>+718-232-0114 800-581-0887<br>brienzas.com VUTT</td>
                    </tr>
                    <tr>
                        <th colspan="2" style="height:40px;">'. $schedule->worktype_name.' Sign- In Log</th>
                    </tr>
                    ...
                    $logDatanew .= '
                        ...
                        <tr>
                            <td style="height:50px;"><strong>Principal’s Signature:</strong><img src="'.base_url().$data['content'].'"width="80" height="50"></td>
                            <td style="padding-top:40px; font-size:13px;"><strong>Total Hours:</strong>'.$schedule->total_hours.'</td>
                    </tr>
