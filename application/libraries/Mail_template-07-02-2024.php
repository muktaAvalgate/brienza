  ...
  * */  
  public function register_coordinator_email($name = NULL, $email = NULL, $id = NULL) {
   ...
   public function notification_email_to_school($name = NULL, $email = NULL, $message = NULL, $role=NULL , $moduleName = NULL)
    ...
    public function notification_email_usernameChanged($name = NULL, $email = NULL) {
      ...
      $message = "<p><strong>Dear ".$name.",</strong><br/></p>
              <p>Your e-mail id has been successfully changed. Please use this new e-mail id as the username for login.</p>";
      //$message .= "<p>Thanks,<br /><i>".$this->CI->lang->line('app_site_name')." Team</i></p>";
    ...
    public function notification_email_for_add_schedule($email = NULL, $name = NULL, $subject=NULL, $message=NULL) {

      if ($email == NULL) {
          return false;
      }
      foreach($email as $eml){
        $this->email_to_user($eml, $name, $subject , $message);
      }

      // $this->email_to_user($email, $name, $subject , $message);
    }
